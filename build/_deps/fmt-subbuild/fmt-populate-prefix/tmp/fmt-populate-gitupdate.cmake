...
execute_process(
  COMMAND "C:/Users/Bluescratch/AppData/Local/Programs/Git/cmd/git.exe" --git-dir=.git show-ref "11.1.4"
  WORKING_DIRECTORY "C:/Users/Bluescratch/Documents/Coding/Geode/MainMenuPlus/build/_deps/fmt-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Bluescratch/Documents/Coding/Geode/MainMenuPlus/build/_deps/fmt-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Bluescratch/Documents/Coding/Geode/MainMenuPlus/build/_deps/fmt-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
