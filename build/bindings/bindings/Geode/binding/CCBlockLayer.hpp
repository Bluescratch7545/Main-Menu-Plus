...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x4612fc
     * @note[short] MacOS (Intel): 0x5019a0
     * @note[short] Windows: 0x42430
     * @note[short] iOS: 0x8a228
     * @note[short] Android: Rebinded
     */
     ~CCBlockLayer();

    /**
     * @note[short] MacOS (ARM): 0x461584
     * @note[short] MacOS (Intel): 0x501d20
    ...
    /**
     * @note[short] MacOS (ARM): 0x461710
     * @note[short] MacOS (Intel): 0x501eb0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x8a390
     * @note[short] Android
     */
