...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x447f40
     * @note[short] MacOS (Intel): 0x4e5dd0
     * @note[short] Windows: 0x3b4b20
     * @note[short] iOS: 0x1b5a04
     * @note[short] Android
     */
    void onMenu(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x447ef4
     * @note[short] MacOS (Intel): 0x4e5d80
     * @note[short] Windows: 0x3b4a10
     * @note[short] iOS: 0x1b59b8
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x447b8c
     * @note[short] MacOS (Intel): 0x4e59f0
     * @note[short] Windows: 0x3b4460
     * @note[short] iOS: 0x1b5658
     * @note[short] Android
     */
