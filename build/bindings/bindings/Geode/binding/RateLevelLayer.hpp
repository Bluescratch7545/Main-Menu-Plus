...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x4a8170
     * @note[short] MacOS (Intel): 0x550d00
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x62108
    ...
    /**
     * @note[short] MacOS (ARM): 0x4a8c50
     * @note[short] MacOS (Intel): 0x551910
     * @note[short] Windows: 0x3b2a70
