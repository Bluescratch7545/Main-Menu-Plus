...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0xa84dc
     * @note[short] MacOS (Intel): 0xb8c90
     * @note[short] Windows: 0x399aa0
     * @note[short] iOS: 0x120d98
     * @note[short] Android
     */
    void applyCustomEnterEffect(GameObject* object, bool isRight);

    /**
     * @note[short] MacOS (ARM): 0xa8c7c
     * @note[short] MacOS (Intel): 0xb9650
    ...
    /**
     * @note[short] MacOS (ARM): 0xa4004
     * @note[short] MacOS (Intel): 0xb4000
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0xad19c
     * @note[short] MacOS (Intel): 0xbe7e0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x12507c
     * @note[short] Android: Rebinded
     */
    void loadActiveSaveObjects(gd::vector<SavedActiveObjectState>& p0, gd::vector<SavedSpecialObjectState>& p1);
     ...
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x124f3c
     * @note[short] Android: Rebinded
     */
    void loadDynamicSaveObjects(gd::vector<SavedObjectStateRef>& p0);
     ...
     * @note[short] Windows: 0x398310
     * @note[short] iOS: 0x12004c
     * @note[short] Android
     */
     ...
     * @note[short] Android
     */
    void screenFlipObject(GameObject* p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0xa5a18
     * @note[short] MacOS (Intel): 0xb5cd0
     * @note[short] Windows: 0x395750
     * @note[short] iOS: 0x11eaf0
     * @note[short] Android
     */
    void showEndLayer();
    ...
    /**
     * @note[short] MacOS (ARM): 0xa4a20
     * @note[short] MacOS (Intel): 0xb4b80
     * @note[short] Windows: 0x394f50
     ...
     * @note[short] Windows: 0x395040
     * @note[short] iOS: 0x11e8d8
     * @note[short] Android
     */
    void spawnFirework();
    ...
    /**
     * @note[short] MacOS (ARM): 0x9d8b8
     * @note[short] MacOS (Intel): 0xacac0
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0xa8264
     * @note[short] MacOS (Intel): 0xb8a10
     * @note[short] Windows: 0x3994e0
     * @note[short] iOS: 0x120b50
     * @note[short] Android
     */
