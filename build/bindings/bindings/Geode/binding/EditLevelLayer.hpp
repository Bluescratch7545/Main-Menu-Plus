...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x19f664
     * @note[short] MacOS (Intel): 0x1e8350
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0xebcb8
    ...
    /**
     * @note[short] MacOS (ARM): 0x1a22a4
     * @note[short] MacOS (Intel): 0x1eb1a0
     * @note[short] Windows: 0xd80e0
     * @note[short] iOS: 0xee518
     * @note[short] Android
     */
