...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x8f63c
     * @note[short] MacOS (Intel): 0x9c9b0
    ...
    /**
     * @note[short] MacOS (ARM): 0x90354
     * @note[short] MacOS (Intel): 0x9d850
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x61f30
     * @note[short] Android
     */
    HardStreak* createDuplicate();

    /**
     * @note[short] MacOS (ARM): 0x8f7c4
     * @note[short] MacOS (Intel): 0x9cb60
     * @note[short] Windows: Out of line
