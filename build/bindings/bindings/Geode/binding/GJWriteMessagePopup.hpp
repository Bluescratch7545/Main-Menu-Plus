...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x23e9f4
     * @note[short] MacOS (Intel): 0x296990
     * @note[short] Windows: 0x292ef0
     * @note[short] iOS: 0x2dcb10
     * @note[short] Android
     */
     ...
     * @note[short] iOS: 0x2dca40
     * @note[short] Android
     */
    void onClearBody(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x23e4d8
     * @note[short] MacOS (Intel): 0x296440
     * @note[short] Windows: 0x292ee0
     * @note[short] iOS: 0x2dc67c
     * @note[short] Android
     */
     ...
     * @note[short] iOS: 0x2dc684
     * @note[short] Android
     */
    void onSend(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x23e864
     * @note[short] MacOS (Intel): 0x296820
    ...
    /**
     * @note[short] MacOS (ARM): 0x23f188
     * @note[short] MacOS (Intel): 0x2971d0
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x23e7c8
     * @note[short] MacOS (Intel): 0x2967a0
     * @note[short] Windows: 0x293260
     * @note[short] iOS: 0x2dc928
     * @note[short] Android: Rebinded
     */
    void updateSubject(gd::string subject);

    /**
     * @note[short] MacOS (ARM): 0x23ef14
     * @note[short] MacOS (Intel): 0x296f50
     * @note[short] Windows: 0x293330
     * @note[short] iOS: 0x2dce50
     * @note[short] Android: Rebinded
     */
