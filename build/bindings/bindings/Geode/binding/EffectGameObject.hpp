...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x16b618
     * @note[short] MacOS (Intel): 0x1aa040
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x37f300
     * @note[short] Android
     */
    int getTargetColorIndex();

    /**
     * @note[short] MacOS (ARM): 0x1405bc
     * @note[short] MacOS (Intel): 0x174830
    ...
    /**
     * @note[short] MacOS (ARM): 0x16a198
     * @note[short] MacOS (Intel): 0x1a8220
     * @note[short] Windows: 0x48d2b0
     * @note[short] iOS: 0x37df38
     * @note[short] Android
     */
    void playTriggerEffect();

    /**
     * @note[short] MacOS (ARM): 0x16b8a8
     * @note[short] MacOS (Intel): 0x1aa2a0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x37f560
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x16a468
     * @note[short] MacOS (Intel): 0x1a8540
     * @note[short] Windows: 0x48d780
     * @note[short] iOS: 0x37e128
     * @note[short] Android
     */
    void triggerEffectFinished();

    /**
     * @note[short] MacOS (ARM): 0x16b704
     * @note[short] MacOS (Intel): 0x1aa110
     * @note[short] Windows: 0x48fe30
     * @note[short] iOS: 0x37f3ec
     * @note[short] Android
     */
     ...
     * @note[short] MacOS (Intel): 0x1aa0b0
     * @note[short] Windows: 0x48fdb0
     * @note[short] iOS: 0x37f374
     * @note[short] Android
     */
    void updateSpecialColor();

    /**
     * @note[short] MacOS (ARM): 0x16b8f4
     * @note[short] MacOS (Intel): 0x1aa2f0
