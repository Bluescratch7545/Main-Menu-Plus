...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x1d6870
     * @note[short] MacOS (Intel): 0x2239e0
     * @note[short] Windows: 0x45c2a0
     * @note[short] iOS: 0x131e94
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x1d66f0
     * @note[short] MacOS (Intel): 0x223830
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x131d50
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x1d7e10
     * @note[short] MacOS (Intel): 0x2251a0
    ...
    /**
     * @note[short] MacOS (ARM): 0x1d9138
     * @note[short] MacOS (Intel): 0x227710
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x133f28
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x1d9054
     * @note[short] MacOS (Intel): 0x227610
     * @note[short] Windows: 0x45d980
     * @note[short] iOS: 0x133e84
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x1de210
     * @note[short] MacOS (Intel): 0x22d590
     * @note[short] Windows: 0x465800
     * @note[short] iOS: 0x1373fc
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x1ddf50
     * @note[short] MacOS (Intel): 0x22d2f0
     * @note[short] Windows: 0x4647d0
     * @note[short] iOS: 0x1371dc
     * @note[short] Android
     */
    void updateEaseRateLabel();

    /**
     * @note[short] MacOS (ARM): 0x1d7a48
     * @note[short] MacOS (Intel): 0x224d40
     * @note[short] Windows: 0x45d160
     * @note[short] iOS: 0x132cf4
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x1d8b30
     * @note[short] MacOS (Intel): 0x227070
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x133adc
     * @note[short] Android
     */
