...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x69ebbc
     * @note[short] MacOS (Intel): 0x78aeb0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0xf444c
     * @note[short] Android: Rebinded
     */
     ~MoreVideoOptionsLayer();

    /**
     * @note[short] MacOS (ARM): 0x69e710
     * @note[short] MacOS (Intel): 0x78a9a0
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x69f288
     * @note[short] MacOS (Intel): 0x78b6e0
    ...
    /**
     * @note[short] MacOS (ARM): 0x6a0da4
     * @note[short] MacOS (Intel): 0x78d2a0
    ...
    /**
     * @note[short] MacOS (ARM): 0x69f814
     * @note[short] MacOS (Intel): 0x78bca0
     * @note[short] Windows: 0x365780
     * @note[short] iOS: 0xf4cb4
     * @note[short] Android
     */
    void onClose(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x6a09a8
     * @note[short] MacOS (Intel): 0x78cea0
    ...
    /**
     * @note[short] MacOS (ARM): 0x69f878
     * @note[short] MacOS (Intel): 0x78bd10
    ...
    /**
     * @note[short] MacOS (ARM): 0x69f86c
     * @note[short] MacOS (Intel): 0x78bcf0
    ...
    /**
     * @note[short] MacOS (ARM): 0x69ff90
     * @note[short] MacOS (Intel): 0x78c4a0
