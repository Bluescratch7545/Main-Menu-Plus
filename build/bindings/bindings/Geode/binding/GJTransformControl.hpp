...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x4bdb4
     * @note[short] MacOS (Intel): 0x55060
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x3f4830
     * @note[short] Android: Out of line
     */
     GJTransformControl();

    /**
     * @note[short] MacOS (ARM): 0x4a3e4
     * @note[short] MacOS (Intel): 0x53190
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x3f37c8
