...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x49e6a0
     * @note[short] MacOS (Intel): 0x5458d0
     * @note[short] Windows: 0x16a320
     * @note[short] iOS: 0xb0060
     * @note[short] Android
     */
    int getLastBuildPageForTab(int p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0x49ebbc
     * @note[short] MacOS (Intel): 0x545dc0
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] Windows: 0x16a910
     * @note[short] Android: Rebinded
     */
    void scoreStringToVector(gd::string& p0, gd::vector<int>& p1);
    ...
    /**
     * @note[short] MacOS (ARM): 0x49ed44
     * @note[short] MacOS (Intel): 0x545f50
     * @note[short] Windows: 0x16a690
     * @note[short] iOS: 0xb049c
     * @note[short] Android
     */
    void storeNewLocalScore(int p0, int p1);
