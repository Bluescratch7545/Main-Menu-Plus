...
public:
     ...
     * @note[short] iOS: 0x24f988
     * @note[short] Android
     */
    void deleteLocalScores();

    /**
     * @note[short] Windows: 0x2ed6f0
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x2ed250
     * @note[short] iOS: 0x24f2ac
     * @note[short] Android: Rebinded
     */
    CCMenuItemSpriteExtra* getSpriteButton(gd::string p0, cocos2d::SEL_MenuHandler p1, cocos2d::CCMenu* p2, float p3, cocos2d::CCPoint p4, int p5);
    ...
    /**
     * @note[short] MacOS (ARM): 0x351dd0
     * @note[short] MacOS (Intel): 0x3c9130
     * @note[short] Windows: 0x2edbb0
     * @note[short] iOS: 0x24fd28
     * @note[short] Android
     */
    void reloadLeaderboard(LevelLeaderboardType p0, LevelLeaderboardMode p1);
