...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x2e50e8
     * @note[short] MacOS (Intel): 0x350d00
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x248e4c
     * @note[short] Android: Out of line
     */
     LevelListLayer();

    /**
     * @note[short] MacOS (ARM): 0x2dce44
     * @note[short] MacOS (Intel): 0x3481e0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x241ff8
