...
public:
     ...
     * @note[short] Android: Rebinded
     */
    void createAndAddComment(gd::string p0, int p1);
    ...
    /**
     * @note[short] MacOS (ARM): 0x56d1bc
     * @note[short] MacOS (Intel): 0x6447f0
     * @note[short] Android
     */
    int getLastCommentIDForGame(int p0);
