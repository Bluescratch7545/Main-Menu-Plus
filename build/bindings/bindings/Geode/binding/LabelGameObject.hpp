...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x170cac
     * @note[short] MacOS (Intel): 0x1b05c0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x381d60
     * @note[short] Android
     */
    void updateLabelIfDirty();

    /**
     * @note[short] MacOS (ARM): 0x1707f0
     * @note[short] MacOS (Intel): 0x1b0050
     * @note[short] Windows: 0x49ad40
     * @note[short] iOS: 0x381a24
     * @note[short] Android
     */
