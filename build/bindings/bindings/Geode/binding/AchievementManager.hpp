...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x68210c
     * @note[short] MacOS (Intel): 0x76eb90
    ...
    /**
     * @note[short] MacOS (ARM): 0x68207c
     * @note[short] MacOS (Intel): 0x76eac0
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x681fa8
     * @note[short] MacOS (Intel): 0x76e9d0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0xeb420
     * @note[short] Android
     */
    void firstSetup();
     ...
     * @note[short] iOS: 0xeb5d0
     * @note[short] Android
     */
    cocos2d::CCDictionary* getAchievementsWithID(char const* id);

    /**
     * @note[short] MacOS (ARM): 0x6822d4
     * @note[short] MacOS (Intel): 0x76ed40
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0xeb5c8
     * @note[short] Android
     */
    cocos2d::CCArray* getAllAchievements();

    /**
     * @note[short] MacOS (ARM): 0x681678
     * @note[short] MacOS (Intel): 0x76e0b0
     * @note[short] Windows: 0x39b50
     * @note[short] iOS: 0xeae18
     * @note[short] Android
     */
    cocos2d::CCArray* getAllAchievementsSorted(bool available);

    /**
     * @note[short] MacOS (ARM): 0x6823d0
     * @note[short] MacOS (Intel): 0x76ee40
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android: Rebinded
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x6829cc
     * @note[short] MacOS (Intel): 0x76f530
     * @note[short] Windows: 0x3a470
     * @note[short] iOS: 0xeb958
     * @note[short] Android
     */
    void notifyAchievementWithID(char const* id);

    /**
     * @note[short] MacOS (ARM): 0x6822ac
     * @note[short] MacOS (Intel): 0x76ed10
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x682e90
     * @note[short] MacOS (Intel): 0x76f9b0
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x682c24
     * @note[short] MacOS (Intel): 0x76f750
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0xebaf4
     * @note[short] Android
     */
    void resetAchievement(char const* id);

    /**
     * @note[short] MacOS (ARM): 0x682e9c
     * @note[short] MacOS (Intel): 0x76f9c0
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x682078
     * @note[short] MacOS (Intel): 0x76eab0
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x681858
     * @note[short] MacOS (Intel): 0x76e2a0
     * @note[short] Windows: 0x39e20
     * @note[short] iOS: 0xeaf78
     * @note[short] Android
     */
