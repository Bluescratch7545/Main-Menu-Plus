...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x4feb24
     * @note[short] MacOS (Intel): 0x5ca2f0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x419350
     * @note[short] Android
     */
    int getPage();

    /**
     * @note[short] MacOS (ARM): 0x4feb30
     * @note[short] MacOS (Intel): 0x5ca310
     * @note[short] Windows: 0xd39c0
     * @note[short] iOS: 0x41935c
     * @note[short] Android
     */
