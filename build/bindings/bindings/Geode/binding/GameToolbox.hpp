...
public:
     ...
     * @note[short] Android
     */
    static cocos2d::CCRect contentScaleClipRect(cocos2d::CCRect& p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0x43f440
     * @note[short] MacOS (Intel): 0x4dc370
     * @note[short] Windows: 0x64b70
     * @note[short] iOS: 0x48050
     * @note[short] Android
     */
    static void mergeDictsSaveLargestInt(cocos2d::CCDictionary* p0, cocos2d::CCDictionary* p1);

    /**
     * @note[short] MacOS (ARM): 0x43f6d0
     * @note[short] MacOS (Intel): 0x4dc610
     * @note[short] Windows: 0x64dd0
     * @note[short] iOS: 0x48188
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x43ee10
     * @note[short] MacOS (Intel): 0x4dbd50
     * @note[short] Windows: Out of line
