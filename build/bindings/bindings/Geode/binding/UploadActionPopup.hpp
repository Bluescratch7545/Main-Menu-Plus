...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x239528
     * @note[short] MacOS (Intel): 0x291040
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x2d86a4
     * @note[short] Android
     */
    void closePopup();
    ...
    /**
     * @note[short] MacOS (ARM): 0x23920c
     * @note[short] MacOS (Intel): 0x290d20
     * @note[short] Windows: 0x28e2d0
     * @note[short] iOS: 0x2d8478
     * @note[short] Android
     */
