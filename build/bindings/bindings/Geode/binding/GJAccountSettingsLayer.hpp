...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x235ba8
     * @note[short] MacOS (Intel): 0x28d120
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x2d56c4
    ...
    /**
     * @note[short] MacOS (ARM): 0x23785c
     * @note[short] MacOS (Intel): 0x28f0a0
     * @note[short] Windows: 0x28cd70
