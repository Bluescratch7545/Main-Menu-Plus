...
public:
     ...
     * @note[short] iOS: 0x10de08
     * @note[short] Android
     */
    void loadFromObject(GJSmartTemplate* p0);

    /**
     * @note[short] MacOS (ARM): 0x1f57ac
     * @note[short] MacOS (Intel): 0x246ef0
     * @note[short] Windows: 0xbdda0
     * @note[short] iOS: 0x1158fc
     * @note[short] Android
     */
    void onClick(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x1eb6ec
     * @note[short] MacOS (Intel): 0x23b740
     * @note[short] Windows: 0xbdcb0
     * @note[short] iOS: 0x10e11c
     * @note[short] Android
     */
