...
public:
     ...
     * @note[short] iOS: 0x4ef74
     * @note[short] Android: Out of line
     */
     UILayer();

    /**
     * @note[short] MacOS (ARM): 0x41f2d8
     * @note[short] MacOS (Intel): 0x4b7300
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x4e518
    ...
    /**
     * @note[short] MacOS (ARM): 0x41e370
     * @note[short] MacOS (Intel): 0x4b64c0
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x41d454
     * @note[short] MacOS (Intel): 0x4b52a0
     * @note[short] Windows: 0x4b5340
    ...
    /**
     * @note[short] MacOS (ARM): 0x41d6fc
     * @note[short] MacOS (Intel): 0x4b5560
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x4d438
     * @note[short] Android
     */
    void updateDualMode(bool p0);

    /**
     * @note[short] MacOS (ARM): 0x41d9f8
     * @note[short] MacOS (Intel): 0x4b58b0
     * @note[short] Windows: 0x4b4bb0
     * @note[short] iOS: 0x4d63c
     * @note[short] Android
     */
    void updateUINodeVisibility(bool p0);
