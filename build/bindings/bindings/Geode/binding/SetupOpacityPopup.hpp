...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x4e368
     * @note[short] MacOS (Intel): 0x583a0
     * @note[short] Windows: 0x413840
     * @note[short] iOS: 0x27ea0
     * @note[short] Android
     */
    void sliderChanged(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x4e954
     * @note[short] MacOS (Intel): 0x58a50
     * @note[short] Windows: 0x413e50
     * @note[short] iOS: 0x28308
     * @note[short] Android
     */
    void updateDuration();
    ...
    /**
     * @note[short] MacOS (ARM): 0x4e8e8
     * @note[short] MacOS (Intel): 0x589c0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x2829c
     * @note[short] Android
     */
    void updateOpacity();

    /**
     * @note[short] MacOS (ARM): 0x4e6b8
     * @note[short] MacOS (Intel): 0x58730
     * @note[short] Windows: 0x413d60
     * @note[short] iOS: 0x28098
     * @note[short] Android
     */
    void updateOpacityLabel();

    /**
     * @note[short] MacOS (ARM): 0x4e864
     * @note[short] MacOS (Intel): 0x58920
     * @note[short] Windows: 0x413ee0
     * @note[short] iOS: 0x28218
     * @note[short] Android
     */
    void updateTargetID();
