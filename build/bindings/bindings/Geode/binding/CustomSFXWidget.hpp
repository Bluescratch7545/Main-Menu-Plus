...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x4fee38
     * @note[short] MacOS (Intel): 0x5ca6b0
     * @note[short] Windows: 0xbf920
     * @note[short] iOS: 0x2ef85c
     * @note[short] Android
     */
     ...
     * @note[short] iOS: 0x2f0748
     * @note[short] Android
     */
    void onDelete(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x4ffdec
     * @note[short] MacOS (Intel): 0x5cb6f0
     * @note[short] Windows: 0xc0d10
     * @note[short] iOS: 0x2f0658
     * @note[short] Android
     */
    void onDownload(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x50006c
     * @note[short] MacOS (Intel): 0x5cb9a0
     * @note[short] Windows: 0xc0ee0
     * @note[short] iOS: 0x2f0824
     * @note[short] Android
     */
    void onPlayback(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x50004c
     * @note[short] MacOS (Intel): 0x5cb970
     * @note[short] Windows: 0xc0ec0
     * @note[short] iOS: 0x2f0804
     * @note[short] Android
     */
