...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x3f700c
     * @note[short] MacOS (Intel): 0x489bc0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x3097f4
    ...
    /**
     * @note[short] MacOS (ARM): 0x3fb5c8
     * @note[short] MacOS (Intel): 0x48e800
     * @note[short] Windows: 0x3d13e0
     * @note[short] iOS: 0x30cfb0
     * @note[short] Android
     */
    gd::string getErrorMessage();

    /**
     * @note[short] MacOS (ARM): 0x3f8288
     * @note[short] MacOS (Intel): 0x48b000
    ...
    /**
     * @note[short] MacOS (ARM): 0x3f81fc
     * @note[short] MacOS (Intel): 0x48af80
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x3fab58
     * @note[short] MacOS (Intel): 0x48dd80
    ...
    /**
     * @note[short] MacOS (ARM): 0x3fc164
     * @note[short] MacOS (Intel): 0x48f2d0
     * @note[short] Windows: Out of line
     ...
     * @note[short] iOS: 0x30be6c
     * @note[short] Android
     */
    void showCompletedLevel();

    /**
     * @note[short] MacOS (ARM): 0x3fa8ac
     * @note[short] MacOS (Intel): 0x48da80
