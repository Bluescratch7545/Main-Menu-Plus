...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x256b3c
     * @note[short] MacOS (Intel): 0x2b0c00
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x256ca4
     * @note[short] MacOS (Intel): 0x2b0d80
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x256cf0
     * @note[short] MacOS (Intel): 0x2b0dd0
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x2550dc
     * @note[short] MacOS (Intel): 0x2af0d0
     * @note[short] Windows: 0x2e5640
     * @note[short] iOS: 0x2d84c
     * @note[short] Android
     */
