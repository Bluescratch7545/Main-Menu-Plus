...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x267df4
     * @note[short] MacOS (Intel): 0x2c3d20
     * @note[short] Windows: 0x26b120
     * @note[short] iOS: 0x13a9e4
     * @note[short] Android
     */
    void updateDuration();
    ...
    /**
     * @note[short] MacOS (ARM): 0x267f44
     * @note[short] MacOS (Intel): 0x2c3ea0
     * @note[short] Windows: 0x26ae80
     * @note[short] iOS: 0x13ab1c
     * @note[short] Android
     */
    void updateTargetGroupID();

    /**
     * @note[short] MacOS (ARM): 0x267fc4
     * @note[short] MacOS (Intel): 0x2c3f40
     * @note[short] Windows: 0x26af50
     * @note[short] iOS: 0x13ab9c
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x267e64
     * @note[short] MacOS (Intel): 0x2c3da0
     * @note[short] Windows: 0x26b020
     * @note[short] iOS: 0x13aa4c
     * @note[short] Android
     */
    void updateXMod();
