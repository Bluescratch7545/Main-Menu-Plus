...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x19e2d4
     * @note[short] MacOS (Intel): 0x1e6e30
     * @note[short] Windows: 0xa9520
     * @note[short] iOS: 0x5417c
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x19d45c
     * @note[short] MacOS (Intel): 0x1e5e50
     * @note[short] Windows: 0xa77b0
     * @note[short] iOS: 0x536d4
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0xa7600
     * @note[short] iOS: 0x53720
     * @note[short] Android
     */
