...
public:
     ...
     * @note[short] Android
     */
    virtual float opacityForObject(GameObject* p0);
     ...
     * @note[short] Android
     */
    virtual void activatedAudioTrigger(SFXTriggerGameObject* p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0x123480
     * @note[short] MacOS (Intel): 0x14e400
    ...
    /**
     * @note[short] MacOS (ARM): 0x11fba4
     * @note[short] MacOS (Intel): 0x14a4a0
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x108d18
     * @note[short] MacOS (Intel): 0x12dd80
     * @note[short] Windows: 0x21f990
     * @note[short] iOS: 0x1f4a50
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x12379c
     * @note[short] MacOS (Intel): 0x14e7d0
     * @note[short] Windows: 0x23cc10
     * @note[short] iOS: 0x20811c
     * @note[short] Android: Rebinded
     */
    bool canProcessSFX(SFXTriggerState& p0, gd::unordered_map<int, int>& p1, gd::unordered_map<int, float>& p2, gd::vector<SFXTriggerState>& p3);
     ...
     * @note[short] Android
     */
    void checkCameraLimitAfterTeleport(PlayerObject* p0, float p1);
    ...
    /**
     * @note[short] Windows: 0x228900
     * @note[short] Android
     */
    cocos2d::CCPoint claimMoveAction(int p0, bool p1);
    ...
    /**
     * @note[short] Windows: 0x2286c0
     * @note[short] Android
     */
    void claimRotationAction(int p0, int p1, float& p2, float& p3, bool p4, bool p5);
    ...
    /**
     * @note[short] MacOS (ARM): 0x114340
     * @note[short] MacOS (Intel): 0x13bd30
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x12165c
     * @note[short] MacOS (Intel): 0x14c650
     * @note[short] Windows: 0x23a060
     * @note[short] iOS: 0x2068c0
     * @note[short] Android
     */
    cocos2d::CCParticleSystemQuad* createParticle(int p0, char const* p1, int p2, cocos2d::tCCPositionType p3);
    ...
    /**
     * @note[short] MacOS (ARM): 0x11c834
     * @note[short] MacOS (Intel): 0x1466b0
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0xee104
     * @note[short] MacOS (Intel): 0x10ea30
     * @note[short] Windows: 0x209710
     * @note[short] iOS: 0x1e421c
     * @note[short] Android
     */
    int generateEnterEasingBuffer(int p0, float p1);

    /**
     * @note[short] MacOS (ARM): 0xee07c
     * @note[short] MacOS (Intel): 0x10e9a0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x1e41d8
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0xec074
     * @note[short] MacOS (Intel): 0x10c170
    ...
    /**
     * @note[short] MacOS (ARM): 0xf87c4
     * @note[short] MacOS (Intel): 0x119a80
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0xf2104
     * @note[short] MacOS (Intel): 0x112730
     * @note[short] Windows: 0x20c890
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
    float getGroundHeightForMode(int p0);

    /**
     * @note[short] MacOS (ARM): 0xed194
     * @note[short] MacOS (Intel): 0x10d760
    ...
    /**
     * @note[short] MacOS (ARM): 0x12308c
     * @note[short] MacOS (Intel): 0x14def0
     * @note[short] Windows: 0x23c430
     * @note[short] iOS: 0x207a48
     * @note[short] Android
     */
    float getMinDistance(cocos2d::CCPoint p0, cocos2d::CCArray* p1, float p2, int p3);
    ...
    /**
     * @note[short] MacOS (ARM): 0x107e44
     * @note[short] MacOS (Intel): 0x12cd90
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x107ebc
     * @note[short] MacOS (Intel): 0x12ce00
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0xe5e08
     * @note[short] MacOS (Intel): 0x104150
    ...
    /**
     * @note[short] Windows: 0x2126e0
     * @note[short] Android: Rebinded
     */
    void playKeyframeAnimation(KeyframeAnimTriggerObject* p0, gd::vector<int> const& p1);
    ...
    /**
     * @note[short] MacOS (ARM): 0xe89ec
     * @note[short] MacOS (Intel): 0x107450
    ...
    /**
     * @note[short] Windows: 0x230ab0
     * @note[short] Android
     */
    void preUpdateVisibility(float p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0xf7d44
     * @note[short] MacOS (Intel): 0x118f50
    ...
    /**
     * @note[short] MacOS (ARM): 0x123afc
     * @note[short] MacOS (Intel): 0x14ec60
     * @note[short] Windows: 0x23e880
     * @note[short] iOS: 0x2082e0
     * @note[short] Android
     */
    void processSFXState(SFXTriggerState* p0, SFXTriggerState* p1, int p2, float p3);

    /**
     * @note[short] MacOS (ARM): 0x125454
     * @note[short] MacOS (Intel): 0x151010
     * @note[short] Windows: 0x23edc0
     * @note[short] iOS: 0x209364
     * @note[short] Android: Rebinded
     */
    bool processSongState(int p0, float p1, float p2, int p3, float p4, float p5, gd::vector<SongTriggerState>* p6, SongTriggerGameObject* p7);

    /**
     * @note[short] MacOS (ARM): 0xf8dd0
     * @note[short] MacOS (Intel): 0x11a140
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x113dd0
     * @note[short] MacOS (Intel): 0x13b730
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0xf8454
     * @note[short] MacOS (Intel): 0x1196c0
     * @note[short] Windows: Out of line
     ...
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x20484c
     * @note[short] Android
     */
    void removeTemporaryParticles();

    /**
     * @note[short] MacOS (ARM): 0xf9434
     * @note[short] MacOS (Intel): 0x11a880
     * @note[short] Windows: Out of line
     ...
     * @note[short] Android
     */
    bool resetAreaObjectValues(GameObject* p0, bool p1);
     ...
     * @note[short] Android: Rebinded
     */
    void restoreRemap(EffectGameObject* p0, gd::unordered_map<int, int>& p1);
    ...
    /**
     * @note[short] Windows: 0x224e20
     * @note[short] Android
     */
    void rotateAreaObjects(GameObject* p0, cocos2d::CCArray* p1, float p2, bool p3);

    /**
     * @note[short] MacOS (ARM): 0x110b6c
     * @note[short] MacOS (Intel): 0x1376d0
     * @note[short] Windows: 0x226e20
     * @note[short] iOS: 0x1faee4
     * @note[short] Android
     */
    void rotateObject(GameObject* p0, float p1);
    ...
    /**
     * @note[short] MacOS (ARM): 0xe7d98
     * @note[short] MacOS (Intel): 0x106740
    ...
    /**
     * @note[short] MacOS (ARM): 0xea574
     * @note[short] MacOS (Intel): 0x109bb0
    ...
    /**
     * @note[short] Windows: 0x215920
     * @note[short] Android: Rebinded
     */
    void spawnObjectsInOrder(cocos2d::CCArray* p0, double p1, gd::vector<int> const& p2, int p3, int p4);
    ...
    /**
     * @note[short] Windows: 0x239920
     * @note[short] Android
     */
    void spawnParticleTrigger(int p0, cocos2d::CCPoint p1, float p2, float p3);
    ...
    /**
     * @note[short] MacOS (ARM): 0xf7f74
     * @note[short] MacOS (Intel): 0x1191d0
     * @note[short] Windows: Out of line
     ...
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x1f3ef0
     * @note[short] Android
     */
    void togglePlayerStreakBlend(bool blend);

    /**
     * @note[short] MacOS (ARM): 0x107c88
     * @note[short] MacOS (Intel): 0x12cba0
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x116b1c
     * @note[short] MacOS (Intel): 0x13efa0
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] Windows: 0x224440
     * @note[short] Android
     */
    void transformAreaObjects(GameObject* p0, cocos2d::CCArray* p1, float p2, float p3, bool p4);
    ...
    /**
     * @note[short] MacOS (ARM): 0x111470
     * @note[short] MacOS (Intel): 0x138110
     * @note[short] Windows: 0x2297e0
     * @note[short] iOS: 0x1fb640
     * @note[short] Android
     */
    void triggerAdvancedFollowEditCommand(AdvancedFollowEditObject* p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0xf2730
     * @note[short] MacOS (Intel): 0x112d90
     * @note[short] Windows: 0x21f1e0
     * @note[short] iOS: 0x1e72e4
     * @note[short] Android
     */
    GameObject* tryGetObject(int p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0xe5f78
     * @note[short] MacOS (Intel): 0x1042f0
     * @note[short] Windows: 0x2079c0
    ...
    /**
     * @note[short] MacOS (ARM): 0x11c8ac
     * @note[short] MacOS (Intel): 0x146740
    ...
    /**
     * @note[short] MacOS (ARM): 0x116170
     * @note[short] MacOS (Intel): 0x13e400
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x1207f0
     * @note[short] MacOS (Intel): 0x14b440
     * @note[short] Windows: 0x2388b0
     * @note[short] iOS: 0x205ea4
     * @note[short] Android
     */
    void updateStaticCameraPosToGroup(int p0, bool p1, bool p2, bool p3, float p4, float p5, int p6, float p7, bool p8, float p9);

    /**
     * @note[short] MacOS (ARM): 0xf3800
     * @note[short] MacOS (Intel): 0x113fc0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x1e7bf4
     * @note[short] Android
     */
    void updateTimeMod(float p0, bool p1, bool p2);
