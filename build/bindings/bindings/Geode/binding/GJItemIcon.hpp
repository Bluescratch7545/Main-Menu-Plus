...
public:
     ...
     * @note[short] iOS: 0x3096bc
     * @note[short] Android: Out of line
     */
     GJItemIcon();

    /**
     * @note[short] MacOS (ARM): 0x2f0a9c
     * @note[short] MacOS (Intel): 0x35d7f0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x307b58
     ...
     * @note[short] iOS: 0x308248
     * @note[short] Android
     */
    void darkenStoreItem(cocos2d::ccColor3B p0);

    /**
     * @note[short] MacOS (ARM): 0x2ee44c
     * @note[short] MacOS (Intel): 0x35aee0
     * @note[short] Windows: 0x273940
     * @note[short] iOS: 0x306060
     * @note[short] Android
     */
