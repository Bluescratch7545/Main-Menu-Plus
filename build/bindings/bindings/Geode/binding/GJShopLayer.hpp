...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x2a5160
     * @note[short] MacOS (Intel): 0x30e6c0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x14db54
    ...
    /**
     * @note[short] MacOS (ARM): 0x2a6d00
     * @note[short] MacOS (Intel): 0x3103d0
