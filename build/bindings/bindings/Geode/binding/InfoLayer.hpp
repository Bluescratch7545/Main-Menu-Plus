...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x6ae08c
     * @note[short] MacOS (Intel): 0x79b9d0
     * @note[short] Windows: 0x2b52e0
     * @note[short] iOS: 0x351610
     * @note[short] Android
     */
    CCMenuItemSpriteExtra* getSpriteButton(char const* p0, cocos2d::SEL_MenuHandler p1, cocos2d::CCMenu* p2, float p3, cocos2d::CCPoint p4);
    ...
    /**
     * @note[short] MacOS (ARM): 0x6b0058
     * @note[short] MacOS (Intel): 0x79db60
     * @note[short] Windows: 0x2b7bf0
     * @note[short] iOS: 0x352b7c
     * @note[short] Android
     */
    void reloadWindow();
    ...
    /**
     * @note[short] MacOS (ARM): 0x6ae338
     * @note[short] MacOS (Intel): 0x79bc50
     * @note[short] Windows: 0x2b7ed0
     * @note[short] iOS: 0x3517fc
     * @note[short] Android
     */
    void updateCommentModeButtons();

    /**
     * @note[short] MacOS (ARM): 0x6afc40
     * @note[short] MacOS (Intel): 0x79d6d0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x3528dc
     * @note[short] Android
     */
