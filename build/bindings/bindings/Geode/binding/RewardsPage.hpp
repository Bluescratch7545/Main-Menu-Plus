...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x1bd0b4
     * @note[short] MacOS (Intel): 0x208190
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x1c4608
     * @note[short] Android: Rebinded
     */
     ~RewardsPage();

    /**
     * @note[short] MacOS (ARM): 0x1bd3d0
     * @note[short] MacOS (Intel): 0x2085b0
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x1be150
     * @note[short] MacOS (Intel): 0x209480
