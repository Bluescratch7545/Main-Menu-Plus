...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x1281e8
     * @note[short] MacOS (Intel): 0x1545c0
    ...
    /**
     * @note[short] MacOS (ARM): 0xe0f48
     * @note[short] MacOS (Intel): 0xfe6a0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x1db780
     * @note[short] Android
     */
