...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0xdd504
     * @note[short] MacOS (Intel): 0xf9cd0
    ...
    /**
     * @note[short] MacOS (ARM): 0xc2fe0
     * @note[short] MacOS (Intel): 0xdb170
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x356354
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0xd52f8
     * @note[short] MacOS (Intel): 0xf03b0
     * @note[short] Windows: 0x2d6c10
     * @note[short] iOS: 0x361d3c
     * @note[short] Android
     */
    void breakApartTextObject(TextGameObject* p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0xd58f8
     * @note[short] MacOS (Intel): 0xf0a20
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0xcf8d4
     * @note[short] MacOS (Intel): 0xe9c20
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x35d62c
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0xd5a04
     * @note[short] MacOS (Intel): 0xf0b40
     * @note[short] Windows: 0x2d70c0
     * @note[short] iOS: 0x36223c
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0xd429c
     * @note[short] MacOS (Intel): 0xef070
    ...
    /**
     * @note[short] MacOS (ARM): 0xc6698
     * @note[short] MacOS (Intel): 0xdf200
     * @note[short] Windows: 0x2d8e30
     * @note[short] iOS: 0x358b20
     * @note[short] Android
     */
    void updateAnimateOnTriggerObjects(bool p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0xd38fc
     * @note[short] MacOS (Intel): 0xee5d0
