...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x322c3c
     * @note[short] MacOS (Intel): 0x394470
    ...
    /**
     * @note[short] MacOS (ARM): 0x321734
     * @note[short] MacOS (Intel): 0x392d80
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x12ef80
     ...
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x12f6e4
     * @note[short] Android
     */
    void cancelAndStoleTouch(cocos2d::CCTouch* touch, cocos2d::CCEvent* event);

    /**
     * @note[short] MacOS (ARM): 0x3222dc
     * @note[short] MacOS (Intel): 0x393a40
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x12f680
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x321f60
     * @note[short] MacOS (Intel): 0x3936b0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x12f538
     * @note[short] Android
     */
