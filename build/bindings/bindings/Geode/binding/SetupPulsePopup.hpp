...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x324ed4
     * @note[short] MacOS (Intel): 0x396ea0
    ...
    /**
     * @note[short] MacOS (ARM): 0x329acc
     * @note[short] MacOS (Intel): 0x39c410
     * @note[short] Windows: 0x423b00
     * @note[short] iOS: 0x3afa10
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x329ba4
     * @note[short] MacOS (Intel): 0x39c530
     * @note[short] Windows: 0x423c20
     * @note[short] iOS: 0x3afae8
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x329b38
     * @note[short] MacOS (Intel): 0x39c4a0
     * @note[short] Windows: 0x423b90
     * @note[short] iOS: 0x3afa7c
     * @note[short] Android
     */
    void updateHoldTime();
