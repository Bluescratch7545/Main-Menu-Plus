...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0xc52ec
     * @note[short] MacOS (Intel): 0xdda50
     ...
     * @note[short] iOS: 0x366c8c
     * @note[short] Android
     */
    static LevelSettingsObject* objectFromDict(cocos2d::CCDictionary* p0);

    /**
     * @note[short] MacOS (ARM): 0xc6d84
     * @note[short] MacOS (Intel): 0xdf940
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x359028
