...
public:
     ...
     * @note[short] iOS: 0x322b4c
     * @note[short] Android: Out of line
     */
     CurrencySprite();

    /**
     * @note[short] MacOS (ARM): 0x6a73d8
     * @note[short] MacOS (Intel): 0x794060
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x321f80
     ...
     * @note[short] iOS: 0x321230
     * @note[short] Android
     */
    static CurrencySprite* createWithSprite(cocos2d::CCSprite* sprite);

    /**
     * @note[short] MacOS (ARM): 0x6a7f80
     * @note[short] MacOS (Intel): 0x794c80
     * @note[short] Windows: 0xa46d0
     * @note[short] iOS: 0x322a60
     * @note[short] Android
     */
