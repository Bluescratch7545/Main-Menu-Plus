...
public:
    ...
    /**
     * @note[short] Windows: 0x75c90
     * @note[short] Android
     */
    int checkBoundaryOfCell(cocos2d::CCPoint& p0, float p1);

    /**
     * @note[short] Windows: 0x75b70
     * @note[short] Android
     */
    int checkBoundaryOfCell(TableViewCell* p0);

    /**
     * @note[short] Windows: 0x75d90
     * @note[short] Android
     */
    void checkBoundaryOfContent(float p0);

    /**
     * @note[short] Windows: 0x76350
     * @note[short] Android
     */
    void checkFirstCell(TableViewCell* p0);

    /**
     * @note[short] Windows: 0x76600
     * @note[short] Android
     */
    ...
    /**
     * @note[short] Windows: 0x749b0
     * @note[short] Android
     */
    bool isDuplicateIndexPath(CCIndexPath& p0);

    /**
     * @note[short] Windows: 0x74920
     * @note[short] Android
     */
