...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x62d5b4
     * @note[short] MacOS (Intel): 0x70e670
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x414160
    ...
    /**
     * @note[short] MacOS (ARM): 0x62d698
     * @note[short] MacOS (Intel): 0x70e800
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x630200
     * @note[short] MacOS (Intel): 0x7118b0
     * @note[short] Windows: 0x90d60
     * @note[short] iOS: 0x416828
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x62fe2c
     * @note[short] MacOS (Intel): 0x7114a0
     * @note[short] Windows: 0x91130
     * @note[short] iOS: 0x4165ec
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x6315a8
     * @note[short] MacOS (Intel): 0x712e60
     * @note[short] Windows: 0x91220
     * @note[short] iOS: 0x417794
     * @note[short] Android
     */
    void updateDuration();
    ...
    /**
     * @note[short] MacOS (ARM): 0x631520
     * @note[short] MacOS (Intel): 0x712db0
     * @note[short] Windows: 0x912b0
     * @note[short] iOS: 0x417714
     * @note[short] Android
     */
    void updateOpacity();

    /**
     * @note[short] MacOS (ARM): 0x63019c
     * @note[short] MacOS (Intel): 0x711850
     * @note[short] Windows: 0x91430
     * @note[short] iOS: 0x4167c4
     * @note[short] Android
     */
