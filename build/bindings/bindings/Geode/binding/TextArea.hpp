...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x2a4578
     * @note[short] MacOS (Intel): 0x30da20
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x2a4708
     * @note[short] MacOS (Intel): 0x30dbb0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0xf9df4
     * @note[short] Android
     */
    void showAll();
