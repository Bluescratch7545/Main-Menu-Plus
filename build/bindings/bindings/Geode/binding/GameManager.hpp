...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x201188
     * @note[short] MacOS (Intel): 0x254220
     * @note[short] Windows: 0x1aba70
     * @note[short] iOS: 0x34ed6c
     * @note[short] Android: Rebinded
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x308b48
     * @note[short] MacOS (Intel): 0x378630
     * @note[short] Windows: 0x186cd0
     * @note[short] iOS: 0x31d68c
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x2f766c
     * @note[short] MacOS (Intel): 0x364cb0
     * @note[short] Windows: 0x179790
     * @note[short] iOS: 0x312e84
     * @note[short] Android
     */
     ...
     * @note[short] iOS: 0x31ac2c
     * @note[short] Android
     */
    gd::string dpadConfigToString(UIButtonConfig& p0);
     ...
     * @note[short] Android
     */
    const char* getFontFile(int p0);

    /**
     * @note[short] MacOS (ARM): 0x300d7c
     * @note[short] MacOS (Intel): 0x36fa60
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x3183e0
     * @note[short] Android
     */
    const char* getFontTexture(int p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0x2f7060
     * @note[short] MacOS (Intel): 0x364400
     ...
     * @note[short] Windows: 0x183830
     * @note[short] iOS: 0x31b20c
     * @note[short] Android: Rebinded
     */
    gd::string loadDpadFromString(UIButtonConfig& p0, gd::string p1);
    ...
    /**
     * @note[short] MacOS (ARM): 0x2f6c50
     * @note[short] MacOS (Intel): 0x363ea0
    ...
    /**
     * @note[short] Windows: 0x1876a0
     * @note[short] Android
     */
    void reloadAllStep3();

    /**
     * @note[short] Windows: 0x1877b0
     * @note[short] Android
     */
    void reloadAllStep4();
