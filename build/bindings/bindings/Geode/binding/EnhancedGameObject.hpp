...
public:
     ...
     * @note[short] iOS: 0x264720
     * @note[short] Android: Out of line
     */
     EnhancedGameObject();

    /**
     * @note[short] MacOS (ARM): 0x4d7780
     * @note[short] MacOS (Intel): 0x58a150
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x253cc8
     * @note[short] Android
     */
     ...
     * @note[short] MacOS (Intel): 0x5b4240
     * @note[short] Windows: 0x1a4300
     * @note[short] iOS: 0x262608
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x1f9130
     * @note[short] MacOS (Intel): 0x24ba20
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x3489fc
     * @note[short] Android
     */
    void previewAnimateOnTrigger();

    /**
     * @note[short] MacOS (ARM): 0x4ef08c
     * @note[short] MacOS (Intel): 0x5b8de0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x263ed8
     * @note[short] Android
     */
    void refreshRotateAction();

    /**
     * @note[short] MacOS (ARM): 0x1f9170
     * @note[short] MacOS (Intel): 0x24ba60
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x348a3c
     * @note[short] Android
     */
    void resetSyncedAnimation();

    /**
     * @note[short] MacOS (ARM): 0x1f91a4
     * @note[short] MacOS (Intel): 0x24bab0
     * @note[short] Windows: 0x1a6bf0
     * @note[short] iOS: 0x348a70
     * @note[short] Android
     */
    void setupAnimationVariables();

    /**
     * @note[short] MacOS (ARM): 0x1f8fe0
     * @note[short] MacOS (Intel): 0x24b8c0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x3488dc
     * @note[short] Android
     */
    void triggerAnimation();

    /**
     * @note[short] MacOS (ARM): 0x4ef108
     * @note[short] MacOS (Intel): 0x5b8e60
     * @note[short] Windows: 0x1a4390
     * @note[short] iOS: 0x263ee4
     * @note[short] Android
     */
    void updateRotateAction(float dt);

    /**
     * @note[short] MacOS (ARM): 0x4ec2d8
     * @note[short] MacOS (Intel): 0x5b3c30
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x262198
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x1f8e84
     * @note[short] MacOS (Intel): 0x24b7a0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x3487a4
     * @note[short] Android
     */
