...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x699514
     * @note[short] MacOS (Intel): 0x7853c0
    ...
    /**
     * @note[short] MacOS (ARM): 0x69de9c
     * @note[short] MacOS (Intel): 0x78a0d0
    ...
    /**
     * @note[short] MacOS (ARM): 0x69e6f4
     * @note[short] MacOS (Intel): 0x78a980
    ...
    /**
     * @note[short] MacOS (ARM): 0x69e0f8
     * @note[short] MacOS (Intel): 0x78a300
    ...
    /**
     * @note[short] MacOS (ARM): 0x69e81c
     * @note[short] MacOS (Intel): 0x78ab00
