...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x6bb31c
     * @note[short] MacOS (Intel): 0x7a9ac0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x19eec8
     * @note[short] Android
     */
    void blockUser();
    ...
    /**
     * @note[short] MacOS (ARM): 0x6bc440
     * @note[short] MacOS (Intel): 0x7aac10
     * @note[short] Windows: 0x3aed00
     * @note[short] iOS: 0x19f8f0
     * @note[short] Android
     */
    bool isCorrect(char const* key);

    /**
     * @note[short] MacOS (ARM): 0x6b5db0
     * @note[short] MacOS (Intel): 0x7a3d50
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x6bbf48
     * @note[short] MacOS (Intel): 0x7aa720
     * @note[short] Windows: 0x3aee30
     * @note[short] iOS: 0x19f644
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x6ba750
     * @note[short] MacOS (Intel): 0x7a8e60
     * @note[short] Windows: 0x3aeae0
     * @note[short] iOS: 0x19e708
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x6ba6c4
     * @note[short] MacOS (Intel): 0x7a8dd0
     * @note[short] Windows: 0x3aeab0
     * @note[short] iOS: 0x19e6e4
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x6bb3c8
     * @note[short] MacOS (Intel): 0x7a9b80
     * @note[short] Windows: 0x3af530
     * @note[short] iOS: 0x19ef6c
     * @note[short] Android
     */
    void onNextPage(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x6bb3bc
     * @note[short] MacOS (Intel): 0x7a9b60
     * @note[short] Windows: 0x3af540
     * @note[short] iOS: 0x19ef60
     * @note[short] Android
     */
    void onPrevPage(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x6ba7dc
     * @note[short] MacOS (Intel): 0x7a8ef0
     ...
     * @note[short] iOS: 0x19ee30
     * @note[short] Android
     */
    void showNoAccountError();

    /**
     * @note[short] MacOS (ARM): 0x6bbcec
     * @note[short] MacOS (Intel): 0x7aa4c0
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x6bcc28
     * @note[short] MacOS (Intel): 0x7ab450
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x6bbe2c
     * @note[short] MacOS (Intel): 0x7aa610
