...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x165a10
     * @note[short] MacOS (Intel): 0x1a3270
     * @note[short] Windows: 0x489570
     * @note[short] iOS: 0x37b3a8
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x165ae0
     * @note[short] MacOS (Intel): 0x1a3340
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x165b94
     * @note[short] MacOS (Intel): 0x1a3410
     * @note[short] Windows: 0x4896d0
     * @note[short] iOS: 0x37b4d0
     * @note[short] Android
     */
    void spawnCircle();
    bool m_claimTouch;
