...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x5029cc
     * @note[short] MacOS (Intel): 0x5ce4e0
     * @note[short] Windows: 0x26b120
     * @note[short] iOS: 0x1cb960
     * @note[short] Android
     */
    void updateChance();
    ...
    /**
     * @note[short] MacOS (ARM): 0x502a3c
     * @note[short] MacOS (Intel): 0x5ce560
     * @note[short] Windows: 0x428f20
     * @note[short] iOS: 0x1cb9c8
     * @note[short] Android
     */
    void updateTargetID();

    /**
     * @note[short] MacOS (ARM): 0x502ac0
     * @note[short] MacOS (Intel): 0x5ce600
     * @note[short] Windows: 0x428ff0
     * @note[short] iOS: 0x1cba4c
     * @note[short] Android
     */
