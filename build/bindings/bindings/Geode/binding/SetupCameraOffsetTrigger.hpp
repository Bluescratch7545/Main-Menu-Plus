...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x5755c8
     * @note[short] MacOS (Intel): 0x64d630
     * @note[short] Windows: 0x26b120
     * @note[short] iOS: 0x194038
     * @note[short] Android
     */
    void updateDuration();
    ...
    /**
     * @note[short] MacOS (ARM): 0x575638
     * @note[short] MacOS (Intel): 0x64d6b0
     * @note[short] Windows: 0x3ffaa0
     * @note[short] iOS: 0x1940a0
     * @note[short] Android
     */
    void updateMoveCommandPosX();

    /**
     * @note[short] MacOS (ARM): 0x575710
     * @note[short] MacOS (Intel): 0x64d7a0
     * @note[short] Windows: 0x3ffb90
     * @note[short] iOS: 0x194168
     * @note[short] Android
     */
