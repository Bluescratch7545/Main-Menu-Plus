...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x2d3480
     * @note[short] MacOS (Intel): 0x33d050
     * @note[short] Windows: 0x40fc0
     * @note[short] iOS: 0x2fe030
     * @note[short] Android
     */
