...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x629a68
     * @note[short] MacOS (Intel): 0x70a490
    ...
    /**
     * @note[short] MacOS (ARM): 0x6299ac
     * @note[short] MacOS (Intel): 0x70a3d0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x1ba800
     * @note[short] Android
     */
