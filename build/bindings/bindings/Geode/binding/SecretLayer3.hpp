...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x3fcf18
     * @note[short] MacOS (Intel): 0x4901b0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x30dd18
    ...
    /**
     * @note[short] MacOS (ARM): 0x3fe834
     * @note[short] MacOS (Intel): 0x491c00
     * @note[short] Windows: 0x3d4480
     * @note[short] iOS: 0x30f0d0
     * @note[short] Android
     */
    void animateEyes();

    /**
     * @note[short] MacOS (ARM): 0x3ff9a0
     * @note[short] MacOS (Intel): 0x492f60
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x30fee0
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x3d45a0
     * @note[short] iOS: 0x30ff9c
     * @note[short] Android
     */
    void firstInteractionStep2();

    /**
     * @note[short] MacOS (ARM): 0x3ffe34
     * @note[short] MacOS (Intel): 0x493440
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x310288
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x3d4b20
     * @note[short] iOS: 0x3103f0
     * @note[short] Android
     */
    void firstInteractionStep4();

    /**
     * @note[short] MacOS (ARM): 0x3ff850
     * @note[short] MacOS (Intel): 0x492e20
     * @note[short] Windows: 0x3d82b0
     * @note[short] iOS: 0x30fe5c
     * @note[short] Android
     */
    void onBack(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x3ff650
     * @note[short] MacOS (Intel): 0x492c80
     * @note[short] Windows: 0x3d4180
     * @note[short] iOS: 0x30fc84
     * @note[short] Android
     */
    void onChest01(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x3ff750
     * @note[short] MacOS (Intel): 0x492d50
     * @note[short] Windows: 0x3d4300
     * @note[short] iOS: 0x30fd70
     * @note[short] Android
     */
     ...
     * @note[short] iOS: 0x30f1c0
     * @note[short] Android
     */
    void onClick(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x400364
     * @note[short] MacOS (Intel): 0x493980
     * @note[short] Windows: 0x3d68b0
     * @note[short] iOS: 0x3106d8
     * @note[short] Android
     */
    void revealStep1();
     ...
     * @note[short] iOS: 0x310bc4
     * @note[short] Android
     */
    void revealStep2();

    /**
     * @note[short] MacOS (ARM): 0x400c40
     * @note[short] MacOS (Intel): 0x4942b0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x310e14
     * @note[short] Android
     */
    void revealStep3();
