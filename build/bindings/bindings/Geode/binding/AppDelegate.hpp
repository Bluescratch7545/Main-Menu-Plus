...
public:
     ...
     * @note[short] iOS: 0x268954
     * @note[short] Android
     */
    virtual void willSwitchToScene(cocos2d::CCScene* p0);

    /**
     * @note[short] MacOS (ARM): 0x56e730
     * @note[short] MacOS (Intel): 0x645f90
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x56eb00
     * @note[short] MacOS (Intel): 0x6463d0
