...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x4b6a8
     * @note[short] MacOS (Intel): 0x54780
     * @note[short] Windows: 0xdd4b0
     * @note[short] iOS: 0x3f44b0
     * @note[short] Android: Rebinded
     */
     EditorUI();

    /**
     * @note[short] MacOS (ARM): 0xab00
     * @note[short] MacOS (Intel): 0x93e0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x3bd1fc
     * @note[short] Android: Rebinded
     */
     ~EditorUI();
    ...
    /**
     * @note[short] MacOS (ARM): 0x35e80
     * @note[short] MacOS (Intel): 0x3ab90
    ...
    /**
     * @note[short] MacOS (ARM): 0x46220
     * @note[short] MacOS (Intel): 0x4e5d0
     * @note[short] Windows: 0x120ab0
     * @note[short] iOS: 0x3effe8
     * @note[short] Android
     */
    cocos2d::CCPoint applySpecialOffset(cocos2d::CCPoint p0, GameObject* p1, cocos2d::CCPoint p2);
     ...
     * @note[short] MacOS (Intel): 0x41740
     * @note[short] Windows: 0x1140e0
     * @note[short] iOS: 0x3e8ae8
     * @note[short] Android
     */
    void checkDiffAfterTransformAnchor(cocos2d::CCPoint p0, cocos2d::CCArray* p1);
    ...
    /**
     * @note[short] MacOS (ARM): 0x34134
     * @note[short] MacOS (Intel): 0x34bb0
     * @note[short] Windows: 0x116500
     * @note[short] iOS: 0x3e3184
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x43aa4
     * @note[short] MacOS (Intel): 0x4acf0
     ...
     * @note[short] iOS: 0x3e1690
     * @note[short] Android
     */
    void onColorFilter(cocos2d::CCObject* sender);

    /**
     * @note[short] Windows: 0x1118f0
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x2c7e8
     * @note[short] MacOS (Intel): 0x2cc60
    ...
    /**
     * @note[short] MacOS (ARM): 0x2c7cc
     * @note[short] MacOS (Intel): 0x2cc30
    ...
    /**
     * @note[short] MacOS (ARM): 0x2c7b4
     * @note[short] MacOS (Intel): 0x2cc10
    ...
    /**
     * @note[short] MacOS (ARM): 0x461c0
     * @note[short] MacOS (Intel): 0x4e560
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x3eff88
     * @note[short] Android
     */
    cocos2d::CCPoint positionWithoutOffset(GameObject* p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0x35e00
     * @note[short] MacOS (Intel): 0x3ab10
    ...
    /**
     * @note[short] MacOS (ARM): 0x3f3c0
     * @note[short] MacOS (Intel): 0x456e0
     * @note[short] Windows: 0x117680
     * @note[short] iOS: 0x3eb3fc
     * @note[short] Android
     */
    void replaceGroupID(GameObject* p0, int p1, int p2);

    /**
     * @note[short] MacOS (ARM): 0x34094
     * @note[short] MacOS (Intel): 0x34b10
    ...
    /**
     * @note[short] MacOS (ARM): 0x38178
     * @note[short] MacOS (Intel): 0x3d650
     * @note[short] Windows: Out of line
     ...
     * @note[short] iOS: 0x3e1cd8
     * @note[short] Android
     */
    bool shouldDeleteObject(GameObject* p0);

    /**
     * @note[short] MacOS (ARM): 0x46b24
     * @note[short] MacOS (Intel): 0x4efe0
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
    bool shouldSnap(GameObject* p0);
     ...
     * @note[short] Windows: 0x1112a0
     * @note[short] iOS: 0x3e340c
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x2cfc4
     * @note[short] MacOS (Intel): 0x2d530
     * @note[short] Windows: 0xe1730
     * @note[short] iOS: 0x3de3cc
     * @note[short] Android
     */
