...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x2e9268
     * @note[short] MacOS (Intel): 0x355830
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x301c44
    ...
    /**
     * @note[short] MacOS (ARM): 0x2ef6f4
     * @note[short] MacOS (Intel): 0x35c290
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x2ef554
     * @note[short] MacOS (Intel): 0x35c100
     * @note[short] Windows: 0x270a30
     * @note[short] iOS: 0x306d48
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x2ec4b0
     * @note[short] MacOS (Intel): 0x358d10
     * @note[short] Android
     */
     ...
     * @note[short] iOS: 0x3064fc
     * @note[short] Android
     */
    void playRainbowEffect();

    /**
     * @note[short] MacOS (ARM): 0x2efbdc
    ...
    /**
     * @note[short] MacOS (ARM): 0x2eecd4
     * @note[short] MacOS (Intel): 0x35b810
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x2ef3bc
     * @note[short] MacOS (Intel): 0x35bf80
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x306c5c
     * @note[short] Android
     */
    static gd::string titleForUnlock(int id, UnlockType type);

    /**
     * @note[short] MacOS (ARM): 0x2eeb6c
     * @note[short] MacOS (Intel): 0x35b680
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x2ec998
     * @note[short] MacOS (Intel): 0x3591f0
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
