...
public:
     ...
     * @note[short] Windows: 0x15f510
     * @note[short] iOS: 0xac9c8
     * @note[short] Android
     */
    bool blockUser(int p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0x4935d8
     * @note[short] MacOS (Intel): 0x539da0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0xa9b88
     * @note[short] Android: Rebinded
     */
    cocos2d::CCArray* createAndGetAccountComments(gd::string p0, int p1);

    /**
     * @note[short] MacOS (ARM): 0x493688
     * @note[short] MacOS (Intel): 0x539e30
     * @note[short] Windows: 0x15aa50
     * @note[short] iOS: 0xa9c24
     * @note[short] Android: Rebinded
     */
    cocos2d::CCArray* createAndGetCommentsFull(gd::string p0, int p1, bool p2);

    /**
     * @note[short] MacOS (ARM): 0x4931b8
     * @note[short] MacOS (Intel): 0x5399b0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0xa98e8
     * @note[short] Android: Rebinded
     */
    cocos2d::CCArray* createAndGetLevelComments(gd::string p0, int p1);
     ...
     * @note[short] Android
     */
    gd::string createPageInfo(int p0, int p1, int p2);
     ...
     * @note[short] Windows: 0x15cae0
     * @note[short] iOS: 0xab3c0
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x14e3a0
     * @note[short] iOS: 0xa2448
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x1584f0
     * @note[short] iOS: 0xa89c8
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x15a2e0
     * @note[short] iOS: 0xa9984
     * @note[short] Android
     */
     ...
     * @note[short] Android
     */
    gd::string getDifficultyStr(bool p0, bool p1, bool p2, bool p3, bool p4, bool p5, bool p6, bool p7);
     ...
     * @note[short] Windows: 0x15d2d0
     * @note[short] iOS: 0xab778
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x1624b0
     * @note[short] iOS: 0xadf68
     * @note[short] Android: Rebinded
     */
    bool getGJSecretReward(gd::string p0);
    ...
    /**
     * @note[short] Windows: 0x143240
     * @note[short] Android
     */
    GJLevelList* getLocalLevelList(int p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0x48bed4
     * @note[short] MacOS (Intel): 0x531620
     * @note[short] Windows: 0x15b010
     * @note[short] iOS: 0xa530c
     * @note[short] Android
     */
    int getSplitIntFromKey(char const* p0, int p1);

    /**
     * @note[short] Windows: 0x145bf0
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x1606b0
     * @note[short] iOS: 0xac918
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x156a20
     * @note[short] iOS: 0xa774c
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x493084
     * @note[short] MacOS (Intel): 0x5398a0
     * @note[short] Windows: 0x15b110
     * @note[short] iOS: 0xa9854
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x492914
     * @note[short] MacOS (Intel): 0x5390c0
     * @note[short] Windows: 0x159560
    ...
    /**
     * @note[short] MacOS (ARM): 0x46b86c
     * @note[short] MacOS (Intel): 0x50d720
     * @note[short] Windows: 0x15eaa0
     * @note[short] iOS: 0x91000
     * @note[short] Android: Rebinded
     */
    void onAcceptFriendRequestCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46e3d0
     * @note[short] MacOS (Intel): 0x510440
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x92920
     * @note[short] Android: Rebinded
     */
    void onBanUserCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46be34
     * @note[short] MacOS (Intel): 0x50dc90
     * @note[short] Windows: 0x15f820
     * @note[short] iOS: 0x91388
     * @note[short] Android: Rebinded
     */
    void onBlockUserCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46a914
     * @note[short] MacOS (Intel): 0x50c8c0
     * @note[short] Windows: 0x15cfc0
     * @note[short] iOS: 0x90564
     * @note[short] Android: Rebinded
     */
    void onDeleteCommentCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46b660
     * @note[short] MacOS (Intel): 0x50d520
     * @note[short] Windows: 0x15e580
     * @note[short] iOS: 0x90e84
     * @note[short] Android: Rebinded
     */
    void onDeleteFriendRequestCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x468a40
     * @note[short] MacOS (Intel): 0x50a3c0
     * @note[short] Windows: 0x152740
     * @note[short] iOS: 0x8f474
     * @note[short] Android: Rebinded
     */
     ...
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x95540
     * @note[short] Android: Rebinded
     */
    void onDeleteServerLevelListCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46d8bc
     * @note[short] MacOS (Intel): 0x50f860
     * @note[short] Windows: 0x159390
    ...
    /**
     * @note[short] MacOS (ARM): 0x468670
     * @note[short] MacOS (Intel): 0x50a060
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x8f1bc
     * @note[short] Android: Rebinded
     */
    void onDownloadLevelCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46da9c
     * @note[short] MacOS (Intel): 0x50fa30
     * @note[short] Windows: 0x158730
     * @note[short] iOS: 0x923dc
     * @note[short] Android: Rebinded
     */
    void onDownloadUserMessageCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x469890
     * @note[short] MacOS (Intel): 0x50b2e0
     * @note[short] Windows: 0x15a510
     * @note[short] iOS: 0x8fd44
     * @note[short] Android: Rebinded
     */
     ...
     * @note[short] iOS: 0x9197c
     * @note[short] Android: Rebinded
     */
    void onGetFriendRequestsCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x471154
     * @note[short] MacOS (Intel): 0x5136f0
     * @note[short] Windows: 0x14f470
     * @note[short] iOS: 0x947e4
     * @note[short] Android: Rebinded
     */
     ...
     * @note[short] Windows: 0x163d50
     * @note[short] iOS: 0x92e90
     * @note[short] Android: Rebinded
     */
    void onGetGJRewardsCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x47287c
     * @note[short] MacOS (Intel): 0x5150a0
     * @note[short] Windows: 0x162960
     * @note[short] iOS: 0x955f4
     * @note[short] Android: Rebinded
     */
    void onGetGJSecretRewardCompleted(gd::string p0, gd::string p1);
     ...
     * @note[short] iOS: 0x8f7e4
     * @note[short] Android: Rebinded
     */
    void onGetLeaderboardScoresCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x469368
     * @note[short] MacOS (Intel): 0x50ad90
     * @note[short] Windows: 0x159da0
     * @note[short] iOS: 0x8fa64
     * @note[short] Android: Rebinded
     */
    void onGetLevelCommentsCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x470fd8
     * @note[short] MacOS (Intel): 0x513580
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x94674
     * @note[short] Android: Rebinded
     */
     ...
     * @note[short] MacOS (Intel): 0x510610
     * @note[short] Windows: 0x14d020
     * @note[short] iOS: 0x92ae0
     * @note[short] Android: Rebinded
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x472878
     * @note[short] MacOS (Intel): 0x515090
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android: Rebinded
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x471874
     * @note[short] MacOS (Intel): 0x513ef0
     * @note[short] Windows: 0x156d40
    ...
    /**
     * @note[short] MacOS (ARM): 0x46c388
     * @note[short] MacOS (Intel): 0x50e190
     * @note[short] Windows: 0x1601b0
     * @note[short] iOS: 0x91620
     * @note[short] Android: Rebinded
     */
    void onGetUserListCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46d148
     * @note[short] MacOS (Intel): 0x50f040
     * @note[short] Windows: 0x157e70
     * @note[short] iOS: 0x91e30
     * @note[short] Android: Rebinded
     */
    void onGetUserMessagesCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46defc
     * @note[short] MacOS (Intel): 0x50ff90
     * @note[short] Windows: 0x157420
     * @note[short] iOS: 0x92654
     * @note[short] Android: Rebinded
     */
    void onGetUsersCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46aacc
     * @note[short] MacOS (Intel): 0x50ca60
     * @note[short] Windows: 0x161880
     * @note[short] iOS: 0x90680
     * @note[short] Android: Rebinded
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x470d14
     * @note[short] MacOS (Intel): 0x5132a0
     * @note[short] Windows: 0x1532b0
     * @note[short] iOS: 0x944a4
     * @note[short] Android: Rebinded
     */
    void onRateDemonCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x4688a0
     * @note[short] MacOS (Intel): 0x50a230
     * @note[short] Windows: 0x151fc0
     * @note[short] iOS: 0x8f384
     * @note[short] Android: Rebinded
     */
    void onRateStarsCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46baa0
     * @note[short] MacOS (Intel): 0x50d940
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x91168
     * @note[short] Android: Rebinded
     */
    void onReadFriendRequestCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46bbb0
     * @note[short] MacOS (Intel): 0x50da30
     * @note[short] Windows: 0x15f2c0
     * @note[short] iOS: 0x911dc
     * @note[short] Android: Rebinded
     */
    void onRemoveFriendCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46aed0
     * @note[short] MacOS (Intel): 0x50cdf0
     * @note[short] Windows: 0x167ad0
     * @note[short] iOS: 0x90988
     * @note[short] Android: Rebinded
     */
    void onReportLevelCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46e458
     * @note[short] MacOS (Intel): 0x5104c0
     * @note[short] Windows: 0x161fb0
     * @note[short] iOS: 0x92994
     * @note[short] Android: Rebinded
     */
     ...
     * @note[short] Windows: 0x1670f0
     * @note[short] iOS: 0x907c0
     * @note[short] Android: Rebinded
     */
    void onRestoreItemsCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x468d58
     * @note[short] MacOS (Intel): 0x50a6b0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x8f65c
     * @note[short] Android: Rebinded
     */
    void onSetLevelFeaturedCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x468bc8
     * @note[short] MacOS (Intel): 0x50a530
     * @note[short] Windows: 0x153600
     * @note[short] iOS: 0x8f564
     * @note[short] Android: Rebinded
     */
    void onSetLevelStarsCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46aecc
     * @note[short] MacOS (Intel): 0x50cde0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x90950
     * @note[short] Android: Rebinded
     */
    void onSubmitUserInfoCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46e8d0
     * @note[short] MacOS (Intel): 0x510900
     * @note[short] Windows: 0x152be0
     * @note[short] iOS: 0x92d20
     * @note[short] Android: Rebinded
     */
    void onSuggestLevelStarsCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46c124
     * @note[short] MacOS (Intel): 0x50df50
     * @note[short] Windows: 0x15fd40
     * @note[short] iOS: 0x91500
     * @note[short] Android: Rebinded
     */
    void onUnblockUserCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46b04c
     * @note[short] MacOS (Intel): 0x50cf60
     * @note[short] Windows: 0x161010
     * @note[short] iOS: 0x90a68
     * @note[short] Android: Rebinded
     */
    void onUpdateDescriptionCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x468788
     * @note[short] MacOS (Intel): 0x50a140
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x8f2a0
     * @note[short] Android: Rebinded
     */
     ...
     * @note[short] iOS: 0x90024
     * @note[short] Android: Rebinded
     */
    void onUploadCommentCompleted(gd::string response, gd::string tag);

    /**
     * @note[short] MacOS (ARM): 0x46b488
     * @note[short] MacOS (Intel): 0x50d350
     * @note[short] Windows: 0x15dfb0
     * @note[short] iOS: 0x90d3c
     * @note[short] Android: Rebinded
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x46dc78
     * @note[short] MacOS (Intel): 0x50fc20
     * @note[short] Windows: 0x158d00
     * @note[short] iOS: 0x92518
     * @note[short] Android: Rebinded
     */
     ...
     * @note[short] Windows: 0x151930
     * @note[short] iOS: 0xa4674
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x15ec90
     * @note[short] iOS: 0xac4b0
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x15efa0
     * @note[short] iOS: 0xac6e0
     * @note[short] Android
     */
    bool removeFriend(int p0);
     ...
     * @note[short] Windows: 0x167830
     * @note[short] iOS: 0xaefa4
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x161cd0
     * @note[short] iOS: 0xadc30
     * @note[short] Android
     */
     ...
     * @note[short] Android
     */
    void resetCommentTimersForAccountID(int p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0x497f28
     * @note[short] MacOS (Intel): 0x53ed30
     * @note[short] Windows: 0x160840
     * @note[short] iOS: 0xac410
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x491640
     * @note[short] MacOS (Intel): 0x537d50
     * @note[short] Windows: 0x15b220
     * @note[short] iOS: 0xa88b0
     * @note[short] Android: Rebinded
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x4904e8
     * @note[short] MacOS (Intel): 0x536a60
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x1673f0
     * @note[short] iOS: 0xa65f0
     * @note[short] Android
     */
    void submitUserInfo();
     ...
     * @note[short] Windows: 0x1528c0
     * @note[short] iOS: 0xa50b8
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x15fa20
     * @note[short] iOS: 0xaccbc
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x160cc0
     * @note[short] iOS: 0xad108
     * @note[short] Android: Rebinded
     */
     ...
     * @note[short] Windows: 0x14a6c0
     * @note[short] iOS: 0x9fd1c
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x14dd70
     * @note[short] iOS: 0xa1cf0
     * @note[short] Android
     */
