...
public:
     ...
     * @note[short] iOS: 0x2dfc48
     * @note[short] Android
     */
    void onCancel(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x2433ec
     * @note[short] MacOS (Intel): 0x29bba0
     * @note[short] Windows: 0x296400
     * @note[short] iOS: 0x2dfb30
     * @note[short] Android
     */
    void onClose(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x2434d4
     * @note[short] MacOS (Intel): 0x29bc80
     * @note[short] Windows: 0x296220
     * @note[short] iOS: 0x2dfc18
     * @note[short] Android
     */
    void onResetValue(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x2435ac
     * @note[short] MacOS (Intel): 0x29bd50
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x2dfc54
     * @note[short] Android
     */
