...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x2778a8
     * @note[short] MacOS (Intel): 0x2d6aa0
    ...
    /**
     * @note[short] Windows: 0x2540d0
     * @note[short] Android
     */
    void calculateBaseActiveColors();

    /**
     * @note[short] Windows: 0x2544b0
     * @note[short] Android
     */
    void calculateInheritedColor(int p0, ColorAction* p1);

    /**
     * @note[short] MacOS (ARM): 0x2792bc
     * @note[short] MacOS (Intel): 0x2d8f40
     * @note[short] Windows: 0x25c090
     * @note[short] iOS: 0x1a4e8
     * @note[short] Android
     */
    void calculateLightBGColor(cocos2d::ccColor3B p0);
    ...
    /**
     * @note[short] Windows: 0x2566c0
     * @note[short] Android
     */
    void controlActionsForControlID(int p0, GJActionCommand p1);

    /**
     * @note[short] Windows: 0x257020
     * @note[short] Android
     */
    void controlActionsForTrigger(EffectGameObject* p0, GJActionCommand p1);
    ...
    /**
     * @note[short] Windows: 0x255980
     * @note[short] Android: Rebinded
     */
    GroupCommandObject2* createKeyframeCommand(int p0, cocos2d::CCArray* p1, GameObject* p2, int p3, int p4, bool p5, float p6, float p7, float p8, float p9, float p10, float p11, gd::vector<int> const& p12);
    ...
    /**
     * @note[short] Windows: 0x255860
     * @note[short] Android
     */
    void createPlayerFollowCommand(float p0, float p1, int p2, float p3, float p4, int p5, int p6, int p7);

    /**
     * @note[short] Windows: 0x255620
     * @note[short] Android
     */
    void createRotateCommand(float p0, float p1, int p2, int p3, int p4, float p5, bool p6, bool p7, bool p8, int p9, int p10);
    ...
    /**
     * @note[short] MacOS (ARM): 0x279460
     * @note[short] MacOS (Intel): 0x2d90d0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x1a5d4
     * @note[short] Android
     */
    static cocos2d::ccColor3B getMixedColor(cocos2d::ccColor3B color1, cocos2d::ccColor3B color2, float ratio);

    /**
     * @note[short] Windows: 0x257c40
     * @note[short] Android
     */
    CCMoveCNode* getMoveCommandNode(GroupCommandObject2* p0);

    /**
     * @note[short] Windows: 0x257b40
     * @note[short] Android
     */
    ...
    /**
     * @note[short] Windows: 0x257ee0
     * @note[short] Android
     */
    GroupCommandObject2* getTempGroupCommand();

    /**
     * @note[short] Windows: 0x2551b0
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x276e68
     * @note[short] MacOS (Intel): 0x2d5ef0
     * @note[short] Windows: 0x25ad50
     * @note[short] iOS: 0x190a4
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x275528
     * @note[short] MacOS (Intel): 0x2d3ff0
     * @note[short] Windows: 0x25a920
     * @note[short] iOS: 0x18068
     * @note[short] Android: Rebinded
     */
    void spawnGroup(int p0, float p1, bool p2, gd::vector<int> const& p3, int p4, int p5);
     ...
     * @note[short] iOS: 0x19070
     * @note[short] Android
     */
    void storeTriggeredID(int objectUniqueID, int playerUniqueID);

    /**
     * @note[short] MacOS (ARM): 0x2791cc
     * @note[short] MacOS (Intel): 0x2d8de0
     * @note[short] Windows: 0x25bfd0
     * @note[short] iOS: 0x1a4a0
     * @note[short] Android
     */
    double timeForItem(int p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0x276a7c
     * @note[short] MacOS (Intel): 0x2d5a80
    ...
    /**
     * @note[short] Windows: 0x254850
     * @note[short] Android
     */
    bool wouldCreateLoop(InheritanceNode* p0, int p1);
