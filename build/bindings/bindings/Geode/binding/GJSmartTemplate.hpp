...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x38fb80
     * @note[short] MacOS (Intel): 0x413f70
     * @note[short] Windows: 0x2ac080
     * @note[short] iOS: 0xb83c
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x38f514
     * @note[short] MacOS (Intel): 0x4138e0
     * @note[short] Windows: 0x2abdd0
     * @note[short] iOS: 0xb2a8
     * @note[short] Android: Rebinded
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x38fa8c
     * @note[short] MacOS (Intel): 0x413df0
     * @note[short] Windows: 0x2abf90
     * @note[short] iOS: 0xb754
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x38fc84
     * @note[short] MacOS (Intel): 0x4140a0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0xb910
     * @note[short] Android
     */
