...
public:
     ...
     * @note[short] iOS: 0x23574c
     * @note[short] Android: Out of line
     */
     MultilineBitmapFont();

    /**
     * @note[short] MacOS (ARM): 0x3e4e60
     * @note[short] MacOS (Intel): 0x4764a0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x23565c
     * @note[short] Android: Rebinded
     */
     ~MultilineBitmapFont();

    /**
     * @note[short] MacOS (ARM): 0x3e2f44
     * @note[short] MacOS (Intel): 0x474390
     * @note[short] Windows: Out of line
