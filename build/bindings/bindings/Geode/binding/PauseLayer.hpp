...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x34dc74
     * @note[short] MacOS (Intel): 0x3c49f0
    ...
    /**
     * @note[short] MacOS (ARM): 0x34c31c
     * @note[short] MacOS (Intel): 0x3c3050
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x34de6c
     * @note[short] MacOS (Intel): 0x3c4bb0
     * @note[short] Android
     */
    void onRecordReplays(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x34dba0
     * @note[short] MacOS (Intel): 0x3c4930
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x34db9c
     * @note[short] MacOS (Intel): 0x3c4920
     * @note[short] Android
     */
     ...
     * @note[short] iOS: 0x1468bc
     * @note[short] Android
     */
    void onTryEdit(cocos2d::CCObject* sender);

    /**
     * @note[short] MacOS (ARM): 0x34cdf0
     * @note[short] MacOS (Intel): 0x3c3b60
     * @note[short] Windows: 0x367980
     * @note[short] iOS: 0x145f70
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x34db6c
     * @note[short] MacOS (Intel): 0x3c48f0
     * @note[short] Android
     */
