...
public:
    ...
    /**
     * @note[short] MacOS (ARM): 0x64e84
     * @note[short] MacOS (Intel): 0x71470
    ...
    /**
     * @note[short] MacOS (ARM): 0x7fba8
     * @note[short] MacOS (Intel): 0x8bf50
     * @note[short] Windows: 0x1ee660
    ...
    /**
     * @note[short] MacOS (ARM): 0x65c74
     * @note[short] MacOS (Intel): 0x72270
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x65374
     * @note[short] MacOS (Intel): 0x71940
     * @note[short] Windows: 0x1de620
     * @note[short] iOS: 0x332fb4
     * @note[short] Android: Rebinded
     */
    GJRewardItem* createReward(GJRewardType p0, int p1, gd::string p2);
    ...
    /**
     * @note[short] MacOS (ARM): 0x64264
     * @note[short] MacOS (Intel): 0x70870
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x332558
     * @note[short] Android
     */
     ...
     * @note[short] iOS: 0x33648c
     * @note[short] Android
     */
    gd::string getGauntletRewardKey(int p0);

    /**
     * @note[short] MacOS (ARM): 0x5a52c
     * @note[short] MacOS (Intel): 0x65e50
     ...
     * @note[short] Android
     */
    gd::string getListRewardKey(GJLevelList* p0);
    ...
    /**
     * @note[short] MacOS (ARM): 0x7f8cc
     * @note[short] MacOS (Intel): 0x8bc30
     * @note[short] Windows: Out of line
     * @note[short] iOS: Out of line
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x65990
     * @note[short] MacOS (Intel): 0x71f40
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x659c0
     * @note[short] MacOS (Intel): 0x71f80
     * @note[short] Windows: 0x1de9b0
    ...
    /**
     * @note[short] MacOS (ARM): 0x5ff6c
     * @note[short] MacOS (Intel): 0x6c410
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x33027c
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x1df870
     * @note[short] iOS: 0x333f44
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x65bec
     * @note[short] MacOS (Intel): 0x72200
     * @note[short] Windows: 0x1deaa0
    ...
    /**
     * @note[short] MacOS (ARM): 0x5afd4
     * @note[short] MacOS (Intel): 0x66950
     * @note[short] Windows: Out of line
    ...
    /**
     * @note[short] MacOS (ARM): 0x6bb18
     * @note[short] MacOS (Intel): 0x781f0
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x336a94
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x65d58
     * @note[short] MacOS (Intel): 0x72340
     ...
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x333c74
     * @note[short] Android
     */
    void removeQueuedSecondaryChallenge(int position);

    /**
     * @note[short] MacOS (ARM): 0x663d4
     * @note[short] MacOS (Intel): 0x72990
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x3339c8
     * @note[short] Android
     */
     ...
     * @note[short] Windows: 0x1e22e0
     * @note[short] iOS: 0x335d94
     * @note[short] Android
     */
    ...
    /**
     * @note[short] MacOS (ARM): 0x7f8d8
     * @note[short] MacOS (Intel): 0x8bc50
     * @note[short] Windows: Out of line
     * @note[short] iOS: 0x33e16c
     * @note[short] Android
     */
    GJRewardItem* unlockGoldChest(int p0);
