...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlayerObject> : ModifyBase<ModifyDerive<Der, PlayerObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(base::get() + 0x36f5e0, Thiscall, PlayerObject, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x370730, Thiscall, PlayerObject)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x37de80, Thiscall, PlayerObject, checkSnapJumpToObject, GameObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x377370, Thiscall, PlayerObject, convertToClosestRotation, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3771a0, Thiscall, PlayerObject, exitPlatformerAnimateJump, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x386140, Thiscall, PlayerObject, hitGroundNoJump, GameObject*, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x381780, Thiscall, PlayerObject, spawnCircle, )
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(PlayerObject, spawnCircle2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x381d40, Thiscall, PlayerObject, spawnDualCircle, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x381b40, Thiscall, PlayerObject, spawnScaleCircle, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x37e3d0, Thiscall, PlayerObject, updateCollideLeft, float, GameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x37e470, Thiscall, PlayerObject, updateCollideRight, float, GameObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x37b430, Thiscall, PlayerObject, updateRotation, float, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x37ad90, Thiscall, PlayerObject, updateSlopeRotation, float)
