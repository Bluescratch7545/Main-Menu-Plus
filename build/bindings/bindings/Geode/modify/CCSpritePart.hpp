...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCSpritePart> : ModifyBase<ModifyDerive<Der, CCSpritePart>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(base::get() + 0x45820, Thiscall, CCSpritePart, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x46980, Thiscall, CCSpritePart, frameChanged, gd::string)
