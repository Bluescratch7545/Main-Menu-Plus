...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCBezierTo> : ModifyBase<ModifyDerive<Der, cocos2d::CCBezierTo>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, cocos2d::_ccBezierConfig const&>::func(&cocos2d::CCBezierTo::create)), Default, cocos2d::CCBezierTo, create, float, cocos2d::_ccBezierConfig const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<float, cocos2d::_ccBezierConfig const&>::func(&cocos2d::CCBezierTo::initWithDuration)), Thiscall, cocos2d::CCBezierTo, initWithDuration, float, cocos2d::_ccBezierConfig const&)
