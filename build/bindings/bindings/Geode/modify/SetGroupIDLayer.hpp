...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetGroupIDLayer> : ModifyBase<ModifyDerive<Der, SetGroupIDLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e3b50, Thiscall, SetGroupIDLayer, determineStartValues, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e3380, Thiscall, SetGroupIDLayer, onToggleGuide, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e3410, Thiscall, SetGroupIDLayer, onToggleSelectedOrder, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e5520, Thiscall, SetGroupIDLayer, onZLayer, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e55e0, Thiscall, SetGroupIDLayer, onZLayerShift, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e56b0, Thiscall, SetGroupIDLayer, updateEditorLayerID, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e5730, Thiscall, SetGroupIDLayer, updateEditorLayerID2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e5e90, Thiscall, SetGroupIDLayer, updateEditorOrder, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e5b60, Thiscall, SetGroupIDLayer, updateEditorOrderLabel, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e5dc0, Thiscall, SetGroupIDLayer, updateOrderChannel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e5c10, Thiscall, SetGroupIDLayer, updateOrderChannelLabel, )
