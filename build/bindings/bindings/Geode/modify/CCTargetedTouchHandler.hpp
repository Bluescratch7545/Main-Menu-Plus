...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTargetedTouchHandler> : ModifyBase<ModifyDerive<Der, cocos2d::CCTargetedTouchHandler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCTargetedTouchHandler@cocos2d@@QEAA@XZ")), Thiscall, cocos2d::CCTargetedTouchHandler)
