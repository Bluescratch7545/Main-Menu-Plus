...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetColorIDPopup> : ModifyBase<ModifyDerive<Der, SetColorIDPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x294aa0, Thiscall, SetColorIDPopup, init, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x294c80, Thiscall, SetColorIDPopup, onSelectSpecialColor, cocos2d::CCObject*)
		}
	};
}
