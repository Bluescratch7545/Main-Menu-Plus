...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CustomizeObjectLayer> : ModifyBase<ModifyDerive<Der, CustomizeObjectLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xa77b0, Thiscall, CustomizeObjectLayer, sliderChanged, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xa7600, Thiscall, CustomizeObjectLayer, updateKerningLabel, )
