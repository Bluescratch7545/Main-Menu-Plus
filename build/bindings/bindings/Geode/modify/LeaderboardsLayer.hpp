...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LeaderboardsLayer> : ModifyBase<ModifyDerive<Der, LeaderboardsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2bb4e0, Thiscall, LeaderboardsLayer, isCorrect, char const*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2bb9a0, Thiscall, LeaderboardsLayer, onInfo, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2ba5d0, Thiscall, LeaderboardsLayer, setupTabs, )
