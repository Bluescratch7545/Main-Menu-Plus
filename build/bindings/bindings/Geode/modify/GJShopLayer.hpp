...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJShopLayer> : ModifyBase<ModifyDerive<Der, GJShopLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a45f0, Thiscall, GJShopLayer, onSelectItem, cocos2d::CCObject*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJShopLayer, onVideoAd, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a4800, Thiscall, GJShopLayer, showCantAffordMessage, GJStoreItem*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a58e0, Thiscall, GJShopLayer, showReactMessage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2a4580, Thiscall, GJShopLayer, updateCurrencyCounter, )
		}
	};
}
