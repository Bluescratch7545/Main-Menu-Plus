...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UILayer> : ModifyBase<ModifyDerive<Der, UILayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4b5340, Thiscall, UILayer, toggleCheckpointsMenu, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(UILayer, toggleMenuVisibility, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4b4bb0, Thiscall, UILayer, updateUINodeVisibility, bool)
		}
	};
}
