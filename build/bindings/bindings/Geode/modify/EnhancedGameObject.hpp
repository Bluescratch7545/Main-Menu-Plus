...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EnhancedGameObject> : ModifyBase<ModifyDerive<Der, EnhancedGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a4300, Thiscall, EnhancedGameObject, createRotateAction, float, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a4390, Thiscall, EnhancedGameObject, updateRotateAction, float)
