...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelInfoLayer> : ModifyBase<ModifyDerive<Der, LevelInfoLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2e92b0, Thiscall, LevelInfoLayer, confirmOwnerDelete, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2e5640, Thiscall, LevelInfoLayer, shouldDownloadLevel, )
