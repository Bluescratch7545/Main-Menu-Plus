...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MessagesProfilePage> : ModifyBase<ModifyDerive<Der, MessagesProfilePage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13d500, Thiscall, MessagesProfilePage, isCorrect, char const*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x322350, Thiscall, MessagesProfilePage, onUpdate, cocos2d::CCObject*)
