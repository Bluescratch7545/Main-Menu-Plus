...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GroupCommandObject2> : ModifyBase<ModifyDerive<Der, GroupCommandObject2>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x250930, Thiscall, GroupCommandObject2, step, float)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GroupCommandObject2, stepTransformCommand, float, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x250a00, Thiscall, GroupCommandObject2, updateAction, int, float)
