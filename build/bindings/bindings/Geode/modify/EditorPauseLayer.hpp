...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EditorPauseLayer> : ModifyBase<ModifyDerive<Der, EditorPauseLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xdbfe0, Thiscall, EditorPauseLayer, onSong, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xdc090, Thiscall, EditorPauseLayer, updateSongButton, )
		}
	};
}
