...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelLeaderboard> : ModifyBase<ModifyDerive<Der, LevelLeaderboard>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2ed6f0, Thiscall, LevelLeaderboard, getLocalScores, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2ed250, Thiscall, LevelLeaderboard, getSpriteButton, gd::string, cocos2d::SEL_MenuHandler, cocos2d::CCMenu*, float, cocos2d::CCPoint, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2edf40, Thiscall, LevelLeaderboard, isCorrect, char const*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2edbb0, Thiscall, LevelLeaderboard, reloadLeaderboard, LevelLeaderboardType, LevelLeaderboardMode)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2ee2f0, Thiscall, LevelLeaderboard, setupLeaderboard, cocos2d::CCArray*)
		}
	};
}
