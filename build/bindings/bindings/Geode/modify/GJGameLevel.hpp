...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJGameLevel> : ModifyBase<ModifyDerive<Der, GJGameLevel>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(base::get() + 0x13f6d0, Thiscall, GJGameLevel, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x16a320, Thiscall, GJGameLevel, getLastBuildPageForTab, int)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJGameLevel, getLengthKey, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x16adc0, Thiscall, GJGameLevel, getListSnapshot, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(GJGameLevel, saveNewScore, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x169db0, Thiscall, GJGameLevel, savePercentage, int, bool, int, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x16a910, Thiscall, GJGameLevel, scoreStringToVector, gd::string&, gd::vector<int>&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x16a690, Thiscall, GJGameLevel, storeNewLocalScore, int, int)
