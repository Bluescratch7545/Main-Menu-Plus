...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, PlayLayer> : ModifyBase<ModifyDerive<Der, PlayLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x398310, Thiscall, PlayLayer, processLoadedMoveActions, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x399880, Thiscall, PlayLayer, screenFlipObject, GameObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x395750, Thiscall, PlayLayer, showEndLayer, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x395be0, Thiscall, PlayLayer, showTwoPlayerGuide, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x394f50, Thiscall, PlayLayer, spawnCircle, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x395040, Thiscall, PlayLayer, spawnFirework, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3994e0, Thiscall, PlayLayer, updateInvisibleBlock, GameObject*, float, float, float, float, cocos2d::ccColor3B const&)
