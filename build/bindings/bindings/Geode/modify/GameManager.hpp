...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameManager> : ModifyBase<ModifyDerive<Der, GameManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1aba70, Thiscall, GameManager, addGameAnimation, int, int, float, gd::string, gd::string, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x17b1a0, Thiscall, GameManager, checkSteamAchievementUnlock, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x183830, Thiscall, GameManager, loadDpadFromString, UIButtonConfig&, gd::string)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GameManager, loadDPadLayout, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x17f7d0, Thiscall, GameManager, loadFont, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1876a0, Thiscall, GameManager, reloadAllStep3, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1877b0, Thiscall, GameManager, reloadAllStep4, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x17db50, Thiscall, GameManager, resetCoinUnlocks, )
