...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TableView> : ModifyBase<ModifyDerive<Der, TableView>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x75460, Thiscall, TableView, ccTouchCancelled, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3e5a0, Thiscall, TableView, registerWithTouchDispatcher, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x75a90, Thiscall, TableView, scrollWheel, float, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x75c90, Thiscall, TableView, checkBoundaryOfCell, cocos2d::CCPoint&, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x75b70, Thiscall, TableView, checkBoundaryOfCell, TableViewCell*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x75d90, Thiscall, TableView, checkBoundaryOfContent, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x76350, Thiscall, TableView, checkFirstCell, TableViewCell*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x76600, Thiscall, TableView, checkLastCell, TableViewCell*)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(TableView, claimTouch, cocos2d::CCTouch*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x74a50, Thiscall, TableView, deleteTableViewCell, TableViewCell*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x749b0, Thiscall, TableView, isDuplicateIndexPath, CCIndexPath&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x74920, Thiscall, TableView, isDuplicateInVisibleCellArray, CCIndexPath*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x74d00, Thiscall, TableView, reloadData, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x757a0, Thiscall, TableView, touchFinish, cocos2d::CCTouch*)
		}
	};
}
