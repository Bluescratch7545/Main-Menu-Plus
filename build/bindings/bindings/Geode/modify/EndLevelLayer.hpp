...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EndLevelLayer> : ModifyBase<ModifyDerive<Der, EndLevelLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1348e0, Thiscall, EndLevelLayer, currencyEnterFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x134d70, Thiscall, EndLevelLayer, diamondEnterFinished, )
