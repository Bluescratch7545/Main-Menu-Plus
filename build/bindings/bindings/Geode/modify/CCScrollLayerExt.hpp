...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCScrollLayerExt> : ModifyBase<ModifyDerive<Der, CCScrollLayerExt>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x47110, Thiscall, CCScrollLayerExt, doConstraintContent, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x472c0, Thiscall, CCScrollLayerExt, scrollingEnd, )
