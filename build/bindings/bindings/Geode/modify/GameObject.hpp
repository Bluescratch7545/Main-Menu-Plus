...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameObject> : ModifyBase<ModifyDerive<Der, GameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(base::get() + 0x188730, Thiscall, GameObject)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1943f0, Thiscall, GameObject, addCustomColorChild, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x18b6e0, Thiscall, GameObject, addEmptyGlow, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x194530, Thiscall, GameObject, addInternalCustomColorChild, gd::string, cocos2d::CCPoint, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x194600, Thiscall, GameObject, addInternalGlowChild, gd::string, cocos2d::CCPoint)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x194d50, Thiscall, GameObject, addRotation, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x199a50, Thiscall, GameObject, addToColorGroup, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x193e00, Thiscall, GameObject, commonInteractiveSetup, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x18b750, Thiscall, GameObject, createGlow, gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19ec20, Thiscall, GameObject, duplicateColorMode, GameObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19e850, Thiscall, GameObject, getBoxOffset, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x18d450, Thiscall, GameObject, getColorFrame, gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x18d510, Thiscall, GameObject, getGlowFrame, gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x197bb0, Thiscall, GameObject, getParentMode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19eb30, Thiscall, GameObject, getRelativeSpriteColor, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x199620, Thiscall, GameObject, getScalePosDelta, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a0670, Thiscall, GameObject, isBasicTrigger, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x19fb40, Thiscall, GameObject, isSpecialObject, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1abf50, Thiscall, GameObject, perspectiveColorFrame, char const*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1abe10, Thiscall, GameObject, perspectiveFrame, char const*, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1957f0, Thiscall, GameObject, setAreaOpacity, float, float, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1c0380, Thiscall, GameObject, setupPixelScale, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a0720, Thiscall, GameObject, setupSpriteSize, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x18dd00, Thiscall, GameObject, shouldBlendColor, GJSpriteColor*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x193ec0, Thiscall, GameObject, shouldLockX, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1a72e0, Thiscall, GameObject, spawnDefaultPickupParticle, GJBaseGameLayer*)
