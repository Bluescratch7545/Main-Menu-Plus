...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer3> : ModifyBase<ModifyDerive<Der, SecretLayer3>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3d4480, Thiscall, SecretLayer3, animateEyes, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(SecretLayer3, firstInteractionStep1, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3d45a0, Thiscall, SecretLayer3, firstInteractionStep2, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(SecretLayer3, firstInteractionStep3, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3d4b20, Thiscall, SecretLayer3, firstInteractionStep4, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3d82b0, Thiscall, SecretLayer3, onBack, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3d4180, Thiscall, SecretLayer3, onChest01, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3d4300, Thiscall, SecretLayer3, onChest02, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3d5090, Thiscall, SecretLayer3, onClick, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3d68b0, Thiscall, SecretLayer3, revealStep1, )
