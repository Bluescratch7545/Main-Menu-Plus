...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameStatsManager> : ModifyBase<ModifyDerive<Der, GameStatsManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1ee660, Thiscall, GameStatsManager, awardSecretKey, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1db530, Thiscall, GameStatsManager, completedDemonLevel, GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1db3e0, Thiscall, GameStatsManager, completedLevel, GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1dbe30, Thiscall, GameStatsManager, completedMapPack, GJMapPack*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1db7a0, Thiscall, GameStatsManager, completedStarLevel, GJGameLevel*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1de620, Thiscall, GameStatsManager, createReward, GJRewardType, int, gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1eedd0, Thiscall, GameStatsManager, encodeDataTo, DS_Dictionary*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1de9b0, Thiscall, GameStatsManager, getRewardKey, GJRewardType, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1df010, Thiscall, GameStatsManager, getSecondaryQueuedChallenge, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1df870, Thiscall, GameStatsManager, hasCompletedChallenge, GJChallengeItem*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1dae80, Thiscall, GameStatsManager, hasCompletedMainLevel, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1deaa0, Thiscall, GameStatsManager, hasRewardBeenCollected, GJRewardType, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1e1480, Thiscall, GameStatsManager, recountSpecialStats, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1e22e0, Thiscall, GameStatsManager, resetSpecialStatAchievements, )
