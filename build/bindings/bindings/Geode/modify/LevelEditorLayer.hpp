...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LevelEditorLayer> : ModifyBase<ModifyDerive<Der, LevelEditorLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2d3450, Thiscall, LevelEditorLayer, transferDefaultColors, GJEffectManager*, GJEffectManager*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2d8e30, Thiscall, LevelEditorLayer, updateAnimateOnTriggerObjects, bool)
