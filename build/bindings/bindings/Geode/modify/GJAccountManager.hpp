...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJAccountManager> : ModifyBase<ModifyDerive<Der, GJAccountManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(GJAccountManager, addDLToActive, char const*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fe820, Thiscall, GJAccountManager, linkToAccount, gd::string, gd::string, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fba80, Thiscall, GJAccountManager, loginAccount, gd::string, gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fd570, Thiscall, GJAccountManager, onGetAccountSyncURLCompleted, gd::string, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fbee0, Thiscall, GJAccountManager, onLoginAccountCompleted, gd::string, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fb1c0, Thiscall, GJAccountManager, onProcessHttpRequestCompleted, cocos2d::extension::CCHttpClient*, cocos2d::extension::CCHttpResponse*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fb620, Thiscall, GJAccountManager, registerAccount, gd::string, gd::string, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(GJAccountManager, removeDLFromActive, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fd840, Thiscall, GJAccountManager, syncAccount, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(GJAccountManager, unlinkFromAccount, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fea30, Thiscall, GJAccountManager, updateAccountSettings, int, int, int, gd::string, gd::string, gd::string)
		}
	};
}
