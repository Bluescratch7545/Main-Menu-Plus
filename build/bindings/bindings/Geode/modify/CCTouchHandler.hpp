...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCTouchHandler> : ModifyBase<ModifyDerive<Der, cocos2d::CCTouchHandler>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress((HMODULE)base::getCocos(), "??1CCTouchHandler@cocos2d@@QEAA@XZ")), Thiscall, cocos2d::CCTouchHandler)
