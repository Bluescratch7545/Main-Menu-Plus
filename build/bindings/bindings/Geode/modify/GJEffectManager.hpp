...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJEffectManager> : ModifyBase<ModifyDerive<Der, GJEffectManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2540d0, Thiscall, GJEffectManager, calculateBaseActiveColors, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2544b0, Thiscall, GJEffectManager, calculateInheritedColor, int, ColorAction*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x25c090, Thiscall, GJEffectManager, calculateLightBGColor, cocos2d::ccColor3B)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2566c0, Thiscall, GJEffectManager, controlActionsForControlID, int, GJActionCommand)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x257020, Thiscall, GJEffectManager, controlActionsForTrigger, EffectGameObject*, GJActionCommand)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x255980, Thiscall, GJEffectManager, createKeyframeCommand, int, cocos2d::CCArray*, GameObject*, int, int, bool, float, float, float, float, float, float, gd::vector<int> const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x255860, Thiscall, GJEffectManager, createPlayerFollowCommand, float, float, int, float, float, int, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x255620, Thiscall, GJEffectManager, createRotateCommand, float, float, int, int, int, float, bool, bool, bool, int, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x253f40, Thiscall, GJEffectManager, getAllColorActions, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x257c40, Thiscall, GJEffectManager, getMoveCommandNode, GroupCommandObject2*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x257b40, Thiscall, GJEffectManager, getMoveCommandObject, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x257ee0, Thiscall, GJEffectManager, getTempGroupCommand, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2551b0, Thiscall, GJEffectManager, handleObjectCollision, bool, int, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x25ad50, Thiscall, GJEffectManager, removeTriggeredID, int, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x254850, Thiscall, GJEffectManager, wouldCreateLoop, InheritanceNode*, int)
		}
	};
}
