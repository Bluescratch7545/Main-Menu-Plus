...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GManager> : ModifyBase<ModifyDerive<Der, GManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(base::get() + 0x515d0, Thiscall, GManager, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6a7f0, Thiscall, GManager, getCompressedSaveString, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x6a8c0, Thiscall, GManager, loadFromCompressedString, gd::string&)
