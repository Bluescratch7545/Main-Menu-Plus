...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EditorUI> : ModifyBase<ModifyDerive<Der, EditorUI>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x120ab0, Thiscall, EditorUI, applySpecialOffset, cocos2d::CCPoint, GameObject*, cocos2d::CCPoint)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x12bbd0, Default, EditorUI, getSmartObjectKey, int, GJSmartDirection)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x121010, Thiscall, EditorUI, getXMin, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1118f0, Thiscall, EditorUI, onCopy, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x111a80, Thiscall, EditorUI, onPaste, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xe5d60, Thiscall, EditorUI, onResetSpecialFilter, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x10feb0, Thiscall, EditorUI, selectAllWithDirection, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1112a0, Thiscall, EditorUI, showMaxBasicError, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x119010, Thiscall, EditorUI, toggleSpecialEditButtons, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1130f0, Thiscall, EditorUI, updateEditButtonColor, int, cocos2d::ccColor3B)
