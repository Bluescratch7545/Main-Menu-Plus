...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x45c2a0, Thiscall, SetupTriggerPopup, getGroupContainer, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(SetupTriggerPopup, getPageContainer, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x4647d0, Thiscall, SetupTriggerPopup, updateEaseRateLabel, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x45d160, Thiscall, SetupTriggerPopup, updateEditorLabel, )
