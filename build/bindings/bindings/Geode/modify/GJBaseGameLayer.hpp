...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJBaseGameLayer> : ModifyBase<ModifyDerive<Der, GJBaseGameLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x23bea0, Thiscall, GJBaseGameLayer, addProximityVolumeEffect, int, int, SFXTriggerGameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2088a0, Thiscall, GJBaseGameLayer, addRemapTargets, gd::set<int>&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x23cc10, Thiscall, GJBaseGameLayer, canProcessSFX, SFXTriggerState&, gd::unordered_map<int, int>&, gd::unordered_map<int, float>&, gd::vector<SFXTriggerState>&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x228900, Thiscall, GJBaseGameLayer, claimMoveAction, int, bool)
            GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_DEFINED(GJBaseGameLayer, claimParticle, gd::string, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2286c0, Thiscall, GJBaseGameLayer, claimRotationAction, int, int, float&, float&, bool, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x23a060, Thiscall, GJBaseGameLayer, createParticle, int, char const*, int, cocos2d::tCCPositionType)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2126e0, Thiscall, GJBaseGameLayer, playKeyframeAnimation, KeyframeAnimTriggerObject*, gd::vector<int> const&)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x230ab0, Thiscall, GJBaseGameLayer, preUpdateVisibility, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x23e880, Thiscall, GJBaseGameLayer, processSFXState, SFXTriggerState*, SFXTriggerState*, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x23edc0, Thiscall, GJBaseGameLayer, processSongState, int, float, float, int, float, float, gd::vector<SongTriggerState>*, SongTriggerGameObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x217b70, Thiscall, GJBaseGameLayer, restoreRemap, EffectGameObject*, gd::unordered_map<int, int>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x231eb0, Thiscall, GJBaseGameLayer, resumeAudio, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x224e20, Thiscall, GJBaseGameLayer, rotateAreaObjects, GameObject*, cocos2d::CCArray*, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x226e20, Thiscall, GJBaseGameLayer, rotateObject, GameObject*, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x215920, Thiscall, GJBaseGameLayer, spawnObjectsInOrder, cocos2d::CCArray*, double, gd::vector<int> const&, int, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x239920, Thiscall, GJBaseGameLayer, spawnParticleTrigger, int, cocos2d::CCPoint, float, float)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION_ERROR_INLINE(GJBaseGameLayer, togglePlayerStreakBlend, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x224440, Thiscall, GJBaseGameLayer, transformAreaObjects, GameObject*, cocos2d::CCArray*, float, float, bool)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2132f0, Thiscall, GJBaseGameLayer, updateCollisionBlocks, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x206a20, Thiscall, GJBaseGameLayer, updateGroundShadows, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2079c0, Thiscall, GJBaseGameLayer, updateLayerCapacity, gd::string)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2130c0, Thiscall, GJBaseGameLayer, updatePlayerCollisionBlocks, )
